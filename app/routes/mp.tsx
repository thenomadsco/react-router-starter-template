...
const PAGE_CONFIG = {
  ...
  heroSlides: [
    { label: "Khajuraho", alt: "Khajuraho Temples", src: "https://images.unsplash.com/photo-1535941339077-2dd1c7963098?q=80&w=1920&auto=format&fit=crop" },
    { label: "Tigers", alt: "Tiger in Kanha", src: "https://images.unsplash.com/photo-1561731216-c3a4d99437d5?q=80&w=1920&auto=format&fit=crop" },
  ],
  itinerary: [
    { day: "01", title: "Arrival in Jabalpur", desc: "Arrive at Jabalpur. Visit Bhedaghat Marble Rocks and Dhuandhar Falls." },
    { day: "02", title: "Kanha National Park", desc: "Drive to Kanha. Evening leisure and nature walk. This park inspired 'The Jungle Book'." },
    { day: "03", title: "Jungle Safari", desc: "Morning Jeep Safari to spot the Royal Bengal Tiger and Barasingha." },
    { day: "04", title: "Khajuraho", desc: "Drive to Khajuraho. Visit the Western Group of Temples, a UNESCO World Heritage site." },
    { day: "05", title: "Departure", desc: "Explore local crafts before transferring to the airport." },
  ],
};
