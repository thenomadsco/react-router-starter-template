...
const heroImages = [
  ...
  { url: "https://images.unsplash.com/photo-CD4Bpfzj5ro?auto=format&fit=crop&w=2000&q=80", label: "Santorini, Greece" },
  { url: "https://images.unsplash.com/photo-PM4VZZn-YyM?auto=format&fit=crop&w=2000&q=80", label: "Eiffel Tower, Paris" }
];
...
const destinations: Destination[] = [
  ...
  { id: 2, title: "Maldives", category: "International", image: "https://source.unsplash.com/1600x900/?maldives,overwater,villas", tags: ["Honeymoon", "Luxury", "Beaches"], description: "Overwater villas and crystal clear turquoise lagoons." },
  ...
  { id: 7, title: "Sri Lanka", category: "International", image: "https://source.unsplash.com/1600x900/?sri%20lanka,tea%20plantation,ella", tags: ["Nature", "Wildlife", "Beaches"], description: "Diverse landscapes, wildlife, and ancient Buddhist ruins." },
  ...
  { id: 15, title: "USA", category: "International", image: "https://source.unsplash.com/1600x900/?usa,national%20park,skyline", tags: ["City", "Nature", "Diverse"], description: "Diverse experiences from bustling metropolises to vast national parks." },
  { id: 16, title: "South Africa", category: "International", image: "https://source.unsplash.com/1600x900/?south%20africa,cape%20town,table%20mountain", tags: ["Wildlife", "Adventure", "Nature"], description: "Safari adventures, stunning coastlines, and vibrant culture." },
  ...
  { id: 18, title: "Tanzania", category: "International", image: "https://source.unsplash.com/1600x900/?tanzania,serengeti,safari", tags: ["Wildlife", "Safari", "Beaches"], description: "Mount Kilimanjaro, Serengeti safaris, and Zanzibar beaches." },
  ...
  { id: 21, title: "Himachal Pradesh", category: "India", image: "https://source.unsplash.com/1600x900/?himachal%20pradesh,manali,mountains", tags: ["Mountains", "Nature", "Adventure"], description: "Scenic hill stations, pine forests, and snow-capped peaks." },
  { id: 22, title: "Uttarakhand", category: "India", image: "https://source.unsplash.com/1600x900/?uttarakhand,rishikesh,himalayas", tags: ["Mountains", "Spiritual", "Nature"], description: "Land of Gods, featuring pilgrimage sites and Himalayan vistas." },
  ...
  { id: 26, title: "Andaman Islands", category: "India", image: "https://source.unsplash.com/1600x900/?andaman%20islands,beach,lagoon", tags: ["Beaches", "Islands", "Adventure"], description: "Pristine beaches, clear waters, and water sports." },
  { id: 27, title: "North East India", category: "India", image: "https://source.unsplash.com/1600x900/?northeast%20india,meghalaya,mountains", tags: ["Nature", "Culture", "Offbeat"], description: "Unexplored beauty, tribal culture, and biodiversity." },
  { id: 28, title: "Sikkim", category: "India", image: "https://source.unsplash.com/1600x900/?sikkim,gangtok,himalayas", tags: ["Mountains", "Nature", "Monasteries"], description: "Home to Kanchenjunga, scenic landscapes, and monasteries." },
  { id: 29, title: "Meghalaya", category: "India", image: "https://source.unsplash.com/1600x900/?meghalaya,living%20root%20bridge,waterfall", tags: ["Nature", "Waterfalls", "Offbeat"], description: "Abode of Clouds, known for living root bridges and waterfalls." },
  { id: 30, title: "Arunachal Pradesh", category: "India", image: "https://source.unsplash.com/1600x900/?arunachal%20pradesh,tawang,monastery", tags: ["Mountains", "Culture", "Adventure"], description: "Land of the Dawn-Lit Mountains with rich tribal heritage." },
  { id: 31, title: "Karnataka", category: "India", image: "https://source.unsplash.com/1600x900/?hampi,karnataka,temple", tags: ["History", "Nature", "Culture"], description: "Heritage sites like Hampi, coffee plantations in Coorg." },
  { id: 32, title: "Tamil Nadu", category: "India", image: "https://source.unsplash.com/1600x900/?tamil%20nadu,temple,india", tags: ["Culture", "Temples", "Beaches"], description: "Land of temples, rich culture, and coastal beauty." },
  { id: 33, title: "Pondicherry", category: "India", image: "https://source.unsplash.com/1600x900/?pondicherry,india,french%20colony", tags: ["Beaches", "French Colony", "Relaxation"], description: "A touch of French culture on the Indian coast." },
  { id: 34, title: "West Bengal", category: "India", image: "https://source.unsplash.com/1600x900/?darjeeling,west%20bengal,tea", tags: ["Culture", "History", "Mountains"], description: "Cultural richness of Kolkata to the tea gardens of Darjeeling." },
  { id: 35, title: "Odisha", category: "India", image: "https://source.unsplash.com/1600x900/?konark%20temple,odisha,india", tags: ["Culture", "Temples", "Beaches"], description: "Known for its ancient temples, beaches, and tribal culture." },
  { id: 36, title: "Gujarat", category: "India", image: "https://source.unsplash.com/1600x900/?rann%20of%20kutch,gujarat,india", tags: ["Culture", "Wildlife", "White Desert"], description: "Rann of Kutch, Asiatic Lions, and vibrant traditions." }
];
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 font-sans overflow-x-hidden">
      ...
      {/* Founder Section */}
            {/* Discover The Nomads Co */}
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-8">
          <RevealOnScroll>
            <div className="max-w-5xl mx-auto">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-emerald-200 bg-emerald-50 text-xs font-semibold tracking-widest text-emerald-800 shadow-sm">
                <span className="w-2 h-2 rounded-full bg-emerald-500"></span>
                PREMIUM TRAVEL EXPERTS
              </div>

              <h2 className="mt-8 text-4xl md:text-6xl font-extrabold leading-tight tracking-tight text-gray-900">
                Discover the world<br className="hidden sm:block" /> with <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-700 to-indigo-500">The Nomads Co.</span>
              </h2>

              <p className="mt-6 text-lg md:text-xl text-gray-600 leading-relaxed max-w-3xl">
                At The Nomads Co., we believe travel is not just about visiting new places, but about the stories you create and the memories you cherish forever.
                Whether you dream of ancient streets, pristine beaches, or vibrant cultures — we craft the perfect journey for you.
              </p>

              <div className="mt-10 flex items-center gap-6 text-sm text-gray-500">
                <div className="flex -space-x-2">
                  {[1, 2, 3].map((i) => (
                    <div key={i} className="w-9 h-9 rounded-full bg-gray-100 border border-white grid place-items-center text-xs font-semibold text-gray-400">
                      Use
                    </div>
                  ))}
                </div>
...
<section id="about" className="py-20 relative">
      ...
      <section id="destinations" className="py-24 bg-white">
        <div className="container mx-auto px-4 md:px-8">
            <RevealOnScroll>
                <div onClick={() => setShowDestinations(true)} className="group relative overflow-hidden rounded-[2.5rem] cursor-pointer border border-gray-200 bg-white shadow-sm hover:shadow-xl transition-all duration-500">
                    <div className="py-20 px-8 md:py-24 text-center flex flex-col items-center justify-center text-gray-900">
                        <div className="w-16 h-16 mb-6 rounded-2xl bg-emerald-50 border border-emerald-200 grid place-items-center">
                          <Compass className="w-8 h-8 text-emerald-700 group-hover:rotate-45 transition-transform duration-500" />
                        </div>
                        <h2 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-6 text-gray-900">Explore Trending Destinations</h2>
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-700 pr-6 leading-relaxed mb-8">Crafting unforgettable, personalized travel experiences. Your journey, our expertise. Let's explore the world together.</p>
              <div className="flex space-x-4">
                <a href="https://www.instagram.com/thenomadsco/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center hover:bg-blue-600 hover:text-gray-900 transition-all"><Instagram className="w-5 h-5" /></a>
                <a href="https://www.facebook.com/Thenomadsco/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center hover:bg-blue-600 hover:text-gray-900 transition-all"><Facebook className="w-5 h-5" /></a>
                 <a href="mailto:thenomadsco@gmail.com" className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center hover:bg-blue-600 hover:text-gray-900 transition-all"><Mail className="w-5 h-5" /></a>
              </div>
            </div>
            <div>
          ...
          <div className="border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between items-center text-gray-600 font-medium">
            <p className="text-sm">© {new Date().getFullYear()} The Nomads Co. All rights reserved.</p>
             <p className="text-sm mt-4 md:mt-0 flex items-center gap-1">Made with <Heart className="w-4 h-4 text-red-500" /> in India</p>
          </div>
        </div>
      </footer>
    </div>
