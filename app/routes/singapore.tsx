...
const PAGE_CONFIG = {
  ...
  heroSlides: [
    { label: "MBS", alt: "Marina Bay Sands", src: "https://images.unsplash.com/photo-1525625293386-3f8f99389edd?q=80&w=1920&auto=format&fit=crop" },
    { label: "Gardens", alt: "Supertrees", src: "https://images.unsplash.com/photo-1506318137071-a8bcbfd0d8bb?q=80&w=1920&auto=format&fit=crop" },
    { label: "Sentosa", alt: "Island", src: "https://images.unsplash.com/photo-1552392437-1262d140e69b?q=80&w=1920&auto=format&fit=crop" },
    { label: "Jewel", alt: "Waterfall", src: "https://images.unsplash.com/photo-1585250325407-30e49f874136?q=80&w=1920&auto=format&fit=crop" },
  ],
  itinerary: [
    ...
    { day: "02", title: "City Tour & Sentosa", desc: "City highlights including Merlion Park. Afternoon cable car to Sentosa. Wings of Time show." },
    { day: "03", title: "Universal Studios", desc: "Full day of fun at Universal Studios Singapore. Thrilling rides and movie-themed zones." },
    { day: "04", title: "Gardens & MBS", desc: "Visit Gardens by the Bay (Cloud Forest & Flower Dome). Evening views from Marina Bay Sands SkyPark." },
    { day: "05", title: "Zoo or Shopping", desc: "Visit the Singapore Zoo or River Wonders. Afternoon free for shopping at Orchard Road." },
    { day: "06", title: "Departure", desc: "Visit Jewel Changi waterfall before the flight home." },
  ],
};
