...
const heroImages = [
  ...
  {
    url: "https://commons.wikimedia.org/wiki/Special:FilePath/Santorini%2C_Oia.jpg?width=2400",
    label: "Santorini, Greece",
  },
  {
    url: "https://commons.wikimedia.org/wiki/Special:FilePath/Eiffel_Tower_Paris.JPG?width=2400",
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 font-sans overflow-x-hidden">
      ...
      {/* Founder Section (Reverted to previous file details + colors; keeping placement and image) */}
