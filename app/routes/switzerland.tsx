...
const PAGE_CONFIG = {
  title: "Switzerland",
  subtitle: "The Alpine Dream",
  badge: "Best Seller",
  durationLabel: "6 Nights / 7 Days",
  visaLabel: "Schengen Visa",
  seasonLabel: "Best: Apr - Oct",
  heroSlides: [
    { label: "Matterhorn", alt: "Zermatt", src: "/images/slides/switzerland-1-800.webp", srcSet: "/images/slides/switzerland-1-800.webp 800w, /images/slides/switzerland-1-1400.webp 1400w" },
    { label: "Lucerne", alt: "Chapel Bridge", src: "/images/slides/switzerland-2-800.webp", srcSet: "/images/slides/switzerland-2-800.webp 800w, /images/slides/switzerland-2-1400.webp 1400w" },
    { label: "Interlaken", alt: "Lakes", src: "/images/slides/switzerland-3-800.webp", srcSet: "/images/slides/switzerland-3-800.webp 800w, /images/slides/switzerland-3-1400.webp 1400w" },
    { label: "Zurich", alt: "City", src: "/images/slides/switzerland-4-800.webp", srcSet: "/images/slides/switzerland-4-800.webp 800w, /images/slides/switzerland-4-1400.webp 1400w" },
  ],
  itinerary: [
    ...
    { day: "02", title: "Lucerne & Mt. Titlis", desc: "Travel to Lucerne. Visit the Chapel Bridge and Lion Monument. Excursion to Mount Titlis with the rotating Rotair cable car for snow and ice cave experiences." },
    { day: "03", title: "Interlaken & Lakes", desc: "Board the GoldenPass Line train to Interlaken, nestled between Lake Brienz and Lake Thun. Enjoy a boat cruise on the turquoise waters." },
    { day: "04", title: "Jungfraujoch - Top of Europe", desc: "Full-day trip to Jungfraujoch, the highest railway station in Europe. Marvel at the Aletsch Glacier and snow-capped peaks from the Sphinx Observatory." },
    { day: "05", title: "Zermatt & Matterhorn", desc: "Travel to the car-free village of Zermatt. View the iconic Matterhorn peak. Optional Gornergrat railway ride for the best mountain panoramas." },
    { day: "06", title: "Geneva / Montreux", desc: "Visit the chateau de Chillon in Montreux or explore the international city of Geneva, seeing the Jet d'Eau and UN headquarters." },
    { day: "07", title: "Departure", desc: "Train transfer to Zurich or Geneva airport for the flight back home." },
  ],
};
