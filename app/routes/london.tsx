...
const PAGE_CONFIG = {
  ...
  heroSlides: [
    { label: "London", alt: "Big Ben & Westminster", src: "/images/slides/london-1-800.webp", srcSet: "/images/slides/london-1-800.webp 800w, /images/slides/london-1-1400.webp 1400w" },
    { label: "Edinburgh", alt: "Edinburgh Castle", src: "/images/slides/london-2-800.webp", srcSet: "/images/slides/london-2-800.webp 800w, /images/slides/london-2-1400.webp 1400w" },
    { label: "Highlands", alt: "Scottish Highlands", src: "/images/slides/london-3-800.webp", srcSet: "/images/slides/london-3-800.webp 800w, /images/slides/london-3-1400.webp 1400w" },
    { label: "Bath", alt: "Historic Bath", src: "/images/slides/london-4-800.webp", srcSet: "/images/slides/london-4-800.webp 800w, /images/slides/london-4-1400.webp 1400w" },
  ],
  itinerary: [
    { day: "01", title: "Arrival in London", desc: "Arrive at Heathrow Airport and transfer to the central London hotel. Spend the evening with a relaxed walk along the Thames or visit Covent Garden." },
    { day: "02", title: "Royal London Tour", desc: "Enjoy a Hop-on Hop-off sightseeing tour covering Buckingham Palace, Big Ben, Westminster Abbey, and the Tower of London. Optional Thames River cruise." },
    { day: "03", title: "London Icons & Views", desc: "Ride the London Eye for panoramic city views. Explore world-class museums like the British Museum or enjoy shopping at Oxford Street and Harrods." },
    { day: "04", title: "Stonehenge & Bath", desc: "Full-day excursion to the prehistoric monument of Stonehenge and the beautiful Georgian city of Bath. Visit the ancient Roman Baths before returning to London." },
    { day: "05", title: "Harry Potter Studios / Leisure", desc: "Experience the magic at the Warner Bros. Studio Tour London - The Making of Harry Potter. Alternatively, explore the vibrant neighborhoods of Soho and Shoreditch." },
    { day: "06", title: "Edinburgh Excursion", desc: "Travel by train to Edinburgh, Scotland's capital. Explore the historic Royal Mile and visit Edinburgh Castle perched atop a volcanic rock." },
    { day: "07", title: "Departure", desc: "Transfer to the airport for the return flight, filled with memories of royalty and history." },
  ],
};
