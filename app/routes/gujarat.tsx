...
const PAGE_CONFIG = {
  ...
  itinerary: [
    ...
    { day: "02", title: "Statue of Unity Excursion", desc: "Day trip to Kevadia to visit the Statue of Unity, the world's tallest statue. Explore the viewing gallery, Valley of Flowers, and witness the evening Laser Show." },
    { day: "03", title: "Rann of Kutch", desc: "Drive to the Great Rann of Kutch. Check into a traditional Bhunga resort. Head to the White Desert to witness the magical sunset over the endless salt flats." },
    { day: "04", title: "Kutch Exploration", desc: "Visit Kala Dungar (Black Hill) for panoramic views. Explore local artisan villages like Nirona to see Rogan art and copper bell making. Experience the cultural vibrancy of the region." },
    { day: "05", title: "Departure", desc: "Drive back to Ahmedabad or Bhuj for the return flight, concluding the cultural journey." },
  ],
};
