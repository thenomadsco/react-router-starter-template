...
const PAGE_CONFIG = {
  ...
  heroSlides: [
    {
      label: "Rann of Kutch",
      alt: "White Desert Rann of Kutch",
      src: "https://images.unsplash.com/photo-1642841819300-20ed449c02a1?q=80&w=1920&auto=format&fit=crop",
    },
    {
      label: "Statue of Unity",
      alt: "World's tallest statue",
      src: "https://images.unsplash.com/photo-1598886367332-90f7d468eb37?q=80&w=1920&auto=format&fit=crop",
    },
    {
      label: "Sun Temple",
      alt: "Modhera Sun Temple",
      src: "https://images.unsplash.com/photo-1620202636709-1bb62b4293c3?q=80&w=1920&auto=format&fit=crop",
    },
    {
      label: "Gir Forest",
      alt: "Asiatic Lion",
      src: "https://images.unsplash.com/photo-1594895697620-e2609026210f?q=80&w=1920&auto=format&fit=crop",
    },
  ],
  ...
  itinerary: [
    {
      ...
      desc: "Arrive in India's first UNESCO World Heritage City. Visit the Sabarmati Ashram (Gandhi's home) and the intricately carved Adalaj Stepwell. In the evening, enjoy a walk at the Sabarmati Riverfront or visit the Kankaria Lake.",
    },
    {
      day: "02",
      title: "Statue of Unity Day Trip",
      desc: "Drive to Kevadia to witness the engineering marvel, the Statue of Unity (the world's tallest statue). Visit the viewing gallery for a view of the Sardar Sarovar Dam. Explore the Valley of Flowers and the Cactus Garden. Watch the spectacular Laser Show on the statue in the evening.",
    },
    {
      day: "03",
      title: "Ahmedabad to Rann of Kutch",
      desc: "Drive to the Great Rann of Kutch (Dhordo). Check into a traditional Bhunga (mud hut) resort. In the evening, head to the White Desert to witness a magical sunset. The endless expanse of white salt turning pink and purple is a sight to behold.",
    },
    {
      day: "04",
      title: "Kutch Exploration",
      desc: "Visit Kala Dungar (Black Hill), the highest point in Kutch, for a panoramic view of the Rann. Explore the local artisan villages like Nirona to see Rogan art and copper bell making. Experience the cultural programs at the Rann Utsav (during season).",
    },
    {
      day: "05",
      title: "Departure",
      desc: "Drive back to Ahmedabad or Bhuj airport. If time permits, visit the Swaminarayan Temple in Bhuj. Depart with memories of the vibrant culture and the vast white desert.",
    },
  ],
};
