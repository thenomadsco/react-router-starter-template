...
const PAGE_CONFIG = {
  ...
  itinerary: [
    ...
    { day: "02", title: "Burj Khalifa & City", desc: "City tour including Palm Jumeirah. Visit Dubai Mall and the 124th floor of Burj Khalifa." },
    { day: "03", title: "Future & Frame", desc: "Visit the Museum of the Future and the Dubai Frame. Experience the blend of old and new Dubai." },
    { day: "04", title: "Abu Dhabi Day Trip", desc: "Visit the grand Sheikh Zayed Mosque and Ferrari World or Louvre Abu Dhabi." },
    { day: "05", title: "Desert Safari", desc: "Afternoon dune bashing in 4x4s. BBQ dinner, camel riding, and belly dance at the desert camp." },
    { day: "06", title: "Shopping & Leisure", desc: "Day free for shopping. Visit Global Village or Miracle Garden (seasonal)." },
    { day: "07", title: "Departure", desc: "Transfer to the airport for the return flight." },
  ],
};
