  ...
  heroSlides: [
    {
      ...
      src: "https://images.unsplash.com/photo-1535941339077-2dd1c7963098?q=80&w=1920&auto=format&fit=crop",
    },
    {
      label: "Kanha Tiger",
      alt: "Tiger in National Park",
      src: "https://images.unsplash.com/photo-1561731216-c3a4d99437d5?q=80&w=1920&auto=format&fit=crop",
    },
    {
      label: "Bhedaghat",
      alt: "Marble Rocks and Waterfall",
      src: "https://images.unsplash.com/photo-1627894006066-b443b7541703?q=80&w=1920&auto=format&fit=crop",
    },
    {
      label: "Sanchi",
      alt: "Sanchi Stupa",
      src: "https://images.unsplash.com/photo-1600100235372-969bf90e2468?q=80&w=1920&auto=format&fit=crop",
    },
  ],
  ...
  itinerary: [
    {
      ...
      desc: "Arrive at Jabalpur Airport. Head straight to Bhedaghat. Take a boat ride through the stunning Marble Rocks gorge on the Narmada River. Visit the thundering Dhuandhar Falls. Transfer to your hotel in Jabalpur.",
    },
    {
      day: "02",
      title: "Jabalpur to Kanha National Park",
      desc: "Drive to Kanha (approx 4 hours). This dense forest inspired Rudyard Kipling's 'The Jungle Book'. Check into your jungle lodge. Enjoy a nature walk in the evening or a tribal dance performance arranged by the resort.",
    },
    {
      day: "03",
      title: "Kanha Jungle Safari",
      desc: "Early morning Jeep Safari into the core zone. Keep your cameras ready to spot the Royal Bengal Tiger, Barasingha (Swamp Deer), and Leopards. Return for breakfast. Afternoon is at leisure to enjoy the serenity of the forest.",
    },
    {
      day: "04",
      title: "Kanha to Khajuraho",
      desc: "A long but scenic drive to Khajuraho (approx 6-7 hours). Khajuraho is famous for its nagara-style architecture and erotic sculptures. Check into your hotel. In the evening, watch the Light and Sound show at the temple complex.",
    },
    {
      day: "05",
      title: "Khajuraho Temples",
      desc: "Morning tour of the Western Group of Temples, a UNESCO World Heritage site. Marvel at the intricate carvings of the Kandariya Mahadeva Temple. Visit the Eastern group of Jain temples later in the day.",
    },
    {
      day: "06",
      title: "Departure",
      desc: "Transfer to Khajuraho Airport/Station for your return journey. You leave with a mix of spiritual history and thrilling wildlife memories.",
    },
  ],
};
