...
const destinations: Destination[] = [
  ...
  { id: 6,  title: "Vietnam",              category: "International", image: "https://images.unsplash.com/PknaOrb1lVo?auto=format&fit=crop&w=600&q=80",                        tags: ["Nature","Culture","Food"],              description: "Bustling cities, serene limestone islands, and rich history." },
  ...
  { id: 8,  title: "Bhutan",               category: "International", image: "https://images.unsplash.com/ZdwVvRdel8A?auto=format&fit=crop&w=600&q=80",                        tags: ["Mountains","Culture","Peace"],          description: "The last great Himalayan kingdom, shrouded in mystery." },
  ...
  { id: 13, title: "South Korea",          category: "International", image: "https://images.unsplash.com/eVa2FK83K6w?auto=format&fit=crop&w=600&q=80",                        tags: ["Culture","City","Food"],                description: "Dynamic cities, ancient palaces, and trendy pop culture." },
  ...
  { id: 17, title: "Kenya",                category: "International", image: "https://images.unsplash.com/T-LfvX-7IVg?auto=format&fit=crop&w=600&q=80",                        tags: ["Wildlife","Safari","Nature"],           description: "Home of the Great Migration and iconic African wildlife." },
  { id: 18, title: "Tanzania",             category: "International", image: "https://images.unsplash.com/0LwfbRtQ-ac?auto=format&fit=crop&w=600&q=80",                        tags: ["Wildlife","Safari","Beaches"],          description: "Mount Kilimanjaro, Serengeti safaris, and Zanzibar beaches." },

  // ── INDIA ──────────────────────────────────────────────────────────────────
  { id: 19, title: "Kashmir",              category: "India",         image: "https://images.unsplash.com/H8dcf-v98mA?auto=format&fit=crop&w=600&q=80",                        tags: ["Mountains","Nature","Romance"],         description: "Paradise on Earth with stunning valleys and Dal Lake." },
  { id: 20, title: "Leh-Ladakh",           category: "India",         image: "https://images.unsplash.com/IJfpVYlRv5I?auto=format&fit=crop&w=600&q=80",                        tags: ["Adventure","Mountains","Road Trip"],    description: "Stark mountain landscapes, monasteries, and high passes." },
  { id: 21, title: "Himachal Pradesh",     category: "India",         image: "https://images.unsplash.com/Xpwj1j1HX34?auto=format&fit=crop&w=600&q=80",                        tags: ["Mountains","Nature","Adventure"],       description: "Scenic hill stations, pine forests, and snow-capped peaks." },
  { id: 22, title: "Uttarakhand",          category: "India",         image: "https://images.unsplash.com/2u6eLolV1JY?auto=format&fit=crop&w=600&q=80",                        tags: ["Mountains","Spiritual","Nature"],       description: "Land of Gods, featuring pilgrimage sites and Himalayan vistas." },
  { id: 23, title: "Rajasthan",            category: "India",         image: "https://images.unsplash.com/ZgbzOZW9U3o?auto=format&fit=crop&w=600&q=80",                        tags: ["History","Culture","Desert"],           description: "Royal palaces, vibrant culture, and vast desert landscapes." },
  ...
  { id: 26, title: "Andaman Islands",      category: "India",         image: "https://images.unsplash.com/5rRWneZHerU?auto=format&fit=crop&w=600&q=80",                        tags: ["Beaches","Islands","Adventure"],        description: "Pristine beaches, clear waters, and water sports." },
  { id: 27, title: "North East India",     category: "India",         image: "https://images.unsplash.com/IpRIguCAQes?auto=format&fit=crop&w=600&q=80",                        tags: ["Nature","Culture","Offbeat"],           description: "Unexplored beauty, tribal culture, and biodiversity." },
  { id: 28, title: "Sikkim",               category: "India",         image: "https://images.unsplash.com/GdlEMsUsOy0?auto=format&fit=crop&w=600&q=80",                        tags: ["Mountains","Nature","Monasteries"],     description: "Home to Kanchenjunga, scenic landscapes, and monasteries." },
  { id: 29, title: "Meghalaya",            category: "India",         image: "https://images.unsplash.com/fNnpZSdqLoY?auto=format&fit=crop&w=600&q=80",                        tags: ["Nature","Waterfalls","Offbeat"],        description: "Abode of Clouds, known for living root bridges and waterfalls." },
  { id: 30, title: "Arunachal Pradesh",    category: "India",         image: "https://images.unsplash.com/DtiLftxDn_w?auto=format&fit=crop&w=600&q=80",                        tags: ["Mountains","Culture","Adventure"],      description: "Land of the Dawn-Lit Mountains with rich tribal heritage." },
  { id: 31, title: "Karnataka",            category: "India",         image: "https://images.unsplash.com/x3y2phkf7fI?auto=format&fit=crop&w=600&q=80",                        tags: ["History","Nature","Culture"],           description: "Heritage sites like Hampi, coffee plantations in Coorg." },
  { id: 32, title: "Tamil Nadu",           category: "India",         image: "https://images.unsplash.com/5MUB-xgEXfo?auto=format&fit=crop&w=600&q=80",                        tags: ["Culture","Temples","Beaches"],          description: "Land of temples, rich culture, and coastal beauty." },
  { id: 33, title: "Pondicherry",          category: "India",         image: "https://images.unsplash.com/MezU2l13jtg?auto=format&fit=crop&w=600&q=80",                        tags: ["Beaches","French Colony","Relaxation"], description: "A touch of French culture on the Indian coast." },
  { id: 34, title: "West Bengal",          category: "India",         image: "https://images.unsplash.com/baRUk41bhbs?auto=format&fit=crop&w=600&q=80",                        tags: ["Culture","History","Mountains"],        description: "Cultural richness of Kolkata to the tea gardens of Darjeeling." },
  { id: 35, title: "Odisha",               category: "India",         image: "https://images.unsplash.com/aEO1tuMpqb8?auto=format&fit=crop&w=600&q=80",                        tags: ["Culture","Temples","Beaches"],          description: "Known for its ancient temples, beaches, and tribal culture." },
  { id: 36, title: "Gujarat",              category: "India",         image: "https://images.unsplash.com/Ww2pmq2oQ08?auto=format&fit=crop&w=600&q=80",                        tags: ["Culture","Wildlife","White Desert"],    description: "Rann of Kutch, Asiatic Lions, and vibrant traditions." },
  { id: 37, title: "Andhra Pradesh",       category: "India",         image: "https://images.unsplash.com/QESNi9V1_ZE?auto=format&fit=crop&w=600&q=80",                        tags: ["Nature","Rivers","Culture"],            description: "Scenic Godavari rivers, paddy fields, and lush greenery." },
];
