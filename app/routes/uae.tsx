...
const PAGE_CONFIG = {
  ...
  heroSlides: [
    {
      label: "Burj Khalifa",
      alt: "Burj Khalifa skyline at night",
      src: "https://images.unsplash.com/photo-1512453979798-5ea904ac6605?q=80&w=1920&auto=format&fit=crop",
    },
    {
      label: "Sheikh Zayed Mosque",
      alt: "Grand Mosque Abu Dhabi",
      src: "https://images.unsplash.com/photo-1542345097-d86504a557b7?q=80&w=1920&auto=format&fit=crop",
    },
    {
      label: "Desert Safari",
      alt: "Dubai Desert Dunes",
      src: "https://images.unsplash.com/photo-1451337516015-6b6fcd1c9063?q=80&w=1920&auto=format&fit=crop",
    },
    {
      label: "Palm Jumeirah",
      alt: "Aerial view of The Palm",
      src: "https://images.unsplash.com/photo-1518684079-3c830dcef6c0?q=80&w=1920&auto=format&fit=crop",
    },
  ],
  ...
  itinerary: [
    {
      day: "01",
      title: "Arrival in Dubai – The City of Gold",
      desc: "Marhaba! Welcome to the United Arab Emirates. Upon arrival at Dubai International Airport, our representative will escort you to your luxury car for a smooth transfer to your hotel. After checking in, spend the evening aboard a traditional Dhow Cruise at Dubai Marina. Sail past the glittering skyscrapers while enjoying a buffet dinner and live entertainment under the stars.",
    },
    {
      day: "02",
      title: "Modern Dubai & The Burj Khalifa",
      desc: "Today we explore the icons. We start with a photo stop at the Burj Al Arab, the world's only 7-star hotel. Then, we head to The Palm Jumeirah to take the monorail for stunning views of Atlantis. In the evening, we visit the Dubai Mall to witness the dancing fountains before ascending to the 124th floor of the Burj Khalifa. Watching the city lights from the top of the world is an experience you will never forget.",
    },
    {
      day: "03",
      title: "Museum of the Future & Dubai Frame",
      desc: "Step into the year 2071 at the Museum of the Future, an architectural marvel that explores how society might evolve. It is one of the most beautiful buildings on earth. Later, we visit the Dubai Frame, a golden rectangular structure that frames the city—giving you a view of 'Old Dubai' on one side and 'New Dubai' on the other. It’s the perfect blend of past and future.",
    },
    {
      day: "04",
      title: "Abu Dhabi City Tour",
      desc: "We take a day trip to the capital, Abu Dhabi. Our first stop is the majestic Sheikh Zayed Grand Mosque, a masterpiece of white marble and gold. We then drive along the Corniche to see the Emirates Palace hotel. Depending on your preference, we can visit the Louvre Abu Dhabi for art lovers or make a stop at Ferrari World on Yas Island for the thrill-seekers before returning to Dubai.",
    },
    {
      day: "05",
      title: "Desert Safari Adventure",
      desc: "Enjoy a relaxed morning at your hotel pool. In the afternoon, prepare for adrenaline. Our 4x4 Land Cruisers will pick you up for a Desert Safari. Experience the thrill of dune bashing across the golden sands. As the sun sets, we head to a Bedouin-style camp. Enjoy camel riding, henna painting, and a BBQ dinner while watching traditional Tanoura and belly dance performances.",
    },
    {
      day: "06",
      title: "Shopping & Global Village / Miracle Garden",
      desc: "Dubai is a shopper's paradise. Today is free for you to explore the souks (markets) for gold and spices, or visit the Mall of the Emirates for some indoor skiing. If traveling between October and April, we highly recommend a visit to the Global Village (a cultural festival of the world) or the Miracle Garden, home to millions of blooming flowers in the middle of the desert.",
    },
    {
      day: "07",
      title: "Departure",
      desc: "Enjoy a final breakfast overlooking the skyline. Depending on your flight time, our driver will transfer you to the airport. You leave the UAE with memories of record-breaking heights, golden deserts, and warm Arabian hospitality.",
    },
  ],
};
    ...
    <div className="min-h-screen bg-white antialiased selection:bg-[#2D3191]/10 selection:text-[#2D3191] pb-24 sm:pb-0">
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto w-full grid lg:grid-cols-2 gap-10 items-end">
          ...
          <div className="lg:text-right">
            <p className="text-white/80 text-lg mb-6">
              "Witness the impossible in the heart of the desert."
            </p>
            <a
              href="#enquire"
      ...
      <section id="overview" className="py-20 px-6 sm:px-12 max-w-[1000px] mx-auto text-center">
        ...
        <p className="text-lg text-[#1F2328]/70 leading-relaxed">
          Experience the ultimate blend of futuristic innovation and Arabian tradition. This tour takes you from the world's tallest building to the serene dunes of the desert and the architectural masterpiece of the Grand Mosque in Abu Dhabi. It is luxury, adventure, and culture all in one.
        </p>
      </section>
      ...
      <section id="enquire" className="py-20 px-6 sm:px-12 max-w-[800px] mx-auto scroll-mt-24">
        <div className="bg-white p-8 sm:p-12 rounded-[2.5rem] border border-[#E6E8EF] shadow-xl text-center">
          <h2 className="text-3xl font-bold text-[#1F2328] mb-4">Ready for UAE?</h2>
