...
const PAGE_CONFIG = {
  ...
  heroSlides: [
    { label: "Alleppey", alt: "Backwaters", src: "https://images.unsplash.com/photo-1602216056096-3b40cc0c9944?q=80&w=1920&auto=format&fit=crop" },
    { label: "Munnar", alt: "Tea Gardens", src: "https://images.unsplash.com/photo-1593693397690-362cb9666c64?q=80&w=1920&auto=format&fit=crop" },
    { label: "Kochi", alt: "Fishing Nets", src: "https://images.unsplash.com/photo-1590636906232-446757c3df90?q=80&w=1920&auto=format&fit=crop" },
    { label: "Culture", alt: "Kathakali", src: "https://images.unsplash.com/photo-1598188207908-4682c7324748?q=80&w=1920&auto=format&fit=crop" },
  ],
  itinerary: [
    ...
    { day: "02", title: "Munnar Exploration", desc: "Visit Eravikulam National Park to spot the endangered Nilgiri Tahr. Explore the Tea Museum to understand the region's heritage. Later, head to Mattupetty Dam and Echo Point for boating amidst the hills." },
    { day: "03", title: "Munnar to Thekkady", desc: "Drive to Thekkady (Periyar), famous for its wildlife sanctuary. In the evening, enjoy a boat cruise on Periyar Lake to spot wild elephants and diverse birdlife." },
    { day: "04", title: "Houseboat Experience", desc: "Travel to Alleppey to board a private traditional Houseboat. Cruise silently through the tranquil backwaters, passing paddy fields and village life. Enjoy authentic Kerala cuisine prepared fresh on board." },
    { day: "05", title: "Departure", desc: "Disembark after breakfast and drive back to Kochi. Depending on flight timings, visit the historic Fort Kochi area to see the Chinese Fishing Nets and St. Francis Church before the airport drop." },
  ],
};
