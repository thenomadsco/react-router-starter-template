...
const PAGE_CONFIG = {
  ...
  subtitle: "Blue Waters & Coral Reefs",
  ...
  heroSlides: [
    {
      label: "Havelock",
      alt: "Radhanagar Beach turquoise water",
      src: "https://images.unsplash.com/photo-1590050752117-238cb0fb12b1?q=80&w=1920&auto=format&fit=crop",
    },
    {
      label: "Scuba Diving",
      alt: "Underwater coral reef",
      src: "https://images.unsplash.com/photo-1582967788606-a171f1080ca8?q=80&w=1920&auto=format&fit=crop",
    },
    {
      label: "Cellular Jail",
      alt: "Historic Cellular Jail Port Blair",
      src: "https://images.unsplash.com/photo-1629219355734-7d2d0b503049?q=80&w=1920&auto=format&fit=crop",
    },
    {
      label: "Neil Island",
      alt: "Natural Bridge rock formation",
      src: "https://images.unsplash.com/photo-1622307223062-10903332462e?q=80&w=1920&auto=format&fit=crop",
    },
  ],
  ...
  itinerary: [
    {
      ...
      desc: "Land in Port Blair, the capital of the Andamans. Transfer to your hotel. In the afternoon, we visit the historic Cellular Jail (Kala Pani) to pay respects to the freedom fighters. In the evening, witness the moving Light & Sound Show which narrates the history of the Indian freedom struggle.",
    },
    {
      day: "02",
      title: "Port Blair to Havelock Island",
      desc: "Take a private luxury ferry (Makruzz/Nautika) to Havelock Island. Upon arrival, we head straight to Radhanagar Beach, consistently ranked as one of the best beaches in Asia. Its white sands and turquoise waters are perfect for swimming and watching the sunset.",
    },
    {
      day: "03",
      title: "Elephant Beach & Water Sports",
      desc: "We take a speedboat ride to Elephant Beach. This spot is famous for its vibrant coral reefs. You can indulge in snorkeling, sea walking, or glass-bottom boat rides here. The underwater marine life is spectacular. Return to your resort in Havelock for a relaxed evening.",
    },
    {
      day: "04",
      title: "Havelock to Neil Island",
      desc: "Board the ferry to the smaller, quieter Neil Island. Visit the Natural Bridge, a unique rock formation created by the sea. Later, visit Laxmanpur Beach, known for its stunning sunset views and wide stretches of white sand. The vibe here is extremely laid-back.",
    },
    {
      day: "05",
      title: "Return to Port Blair",
      desc: "Enjoy a morning at Bharatpur Beach in Neil Island before taking the ferry back to Port Blair. The evening is free for you to explore the local market for shell handicrafts or visit the Anthropological Museum.",
    },
    {
      day: "06",
      title: "Departure",
      desc: "After breakfast, we transfer you to Veer Savarkar International Airport. Bid farewell to the islands as you fly back with a tan and memories of the crystal-clear ocean.",
    },
  ],
};
