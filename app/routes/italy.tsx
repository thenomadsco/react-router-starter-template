...
const PAGE_CONFIG = {
  ...
  heroSlides: [
    ...
    },
    {
      ...
      src: "https://images.unsplash.com/photo-1514890547357-a9ee288728e0?q=80&w=1920&auto=format&fit=crop",
    },
    {
      label: "Florence",
      alt: "Florence Cathedral (Duomo)",
      src: "https://images.unsplash.com/photo-1543997385-d72db621e25d?q=80&w=1920&auto=format&fit=crop",
    },
    {
      label: "Amalfi Coast",
      alt: "Positano Village",
      src: "https://images.unsplash.com/photo-1533904353181-255e0a3b05f2?q=80&w=1920&auto=format&fit=crop",
    },
  ],
  ...
  itinerary: [
    {
      day: "01",
      title: "Arrival in Rome – The Eternal City",
      desc: "Welcome to Italy! Arrive at Rome Fiumicino Airport where our private driver will meet you and transfer you to your hotel. After checking in, spend your first evening soaking up the atmosphere. Walk to the Spanish Steps or throw a coin into the Trevi Fountain to ensure your return to Rome. Enjoy a classic Italian pizza or pasta for dinner at a local trattoria.",
    },
    {
      day: "02",
      title: "Ancient Rome & The Vatican",
      desc: "After breakfast, prepare for a walk through history. We start with the mighty Colosseum, where gladiators once fought. Walk through the Roman Forum to see the ruins of the ancient empire. In the afternoon, we visit the Vatican City (the smallest country in the world). Marvel at St. Peter's Basilica and seeing Michelangelo's masterpiece on the ceiling of the Sistine Chapel. Overnight in Rome.",
    },
    {
      day: "03",
      title: "Rome to Florence – Renaissance Art",
      desc: "Today we take the high-speed train to Florence, the birthplace of the Renaissance. The journey takes about 1.5 hours. Upon arrival, check into your hotel. In the afternoon, take a walking tour to see the magnificent Duomo (Cathedral) with its red-tiled dome, and the Ponte Vecchio, the famous bridge lined with jewelry shops. Watch the sunset from Piazzale Michelangelo for the best view of the city.",
    },
    {
      day: "04",
      title: "Day Trip to Pisa & Tuscan Countryside",
      desc: "No trip to Italy is complete without seeing the Leaning Tower. We take a morning excursion to Pisa. Take the classic photo holding up the tower! Afterwards, we drive through the beautiful rolling hills of Tuscany, famous for its vineyards and olive groves. We return to Florence in the evening, where you can enjoy a Florentine steak dinner.",
    },
    {
      day: "05",
      title: "Florence to Venice – The Floating City",
      desc: "We board the train again and head north to Venice. As you step out of the station, you will see the Grand Canal right in front of you. A private water taxi will take you to your hotel. In the evening, enjoy a romantic Gondola ride through the narrow canals, listening to the water lap against the ancient buildings. It is a truly magical experience.",
    },
    {
      day: "06",
      title: "Venice Island Tour – Murano & Burano",
      desc: "After breakfast, we take a boat tour to the famous islands of the Venetian Lagoon. First stop is Murano, world-renowned for its glass-blowing factories. Watch a master craftsman create a piece of art. Then we continue to Burano, a fisherman's village famous for its brightly colored houses and lace-making. Return to St. Mark's Square in the afternoon to feed the pigeons and see the Doge's Palace.",
    },
    {
      day: "07",
      title: "Departure from Venice",
      desc: "Enjoy your final Italian cappuccino this morning. Depending on your flight schedule, our water taxi will transfer you to Marco Polo Airport. As you fly out, you'll see the lagoon one last time, taking home memories of history, art, and delicious food. Ciao Italia!",
    },
  ],
};
    ...
    <div className="min-h-screen bg-white antialiased selection:bg-[#2D3191]/10 selection:text-[#2D3191] pb-24 sm:pb-0">
      ...
      <section id="overview" className="py-20 px-6 sm:px-12 max-w-[1000px] mx-auto text-center">
        <h2 className="text-3xl font-semibold text-[#1F2328] mb-6" style={{ fontFamily: "'Playfair Display', serif" }}>
          The Classic Italian Route
        </h2>
        <p className="text-lg text-[#1F2328]/70 leading-relaxed">
          This is the dream trip—Rome, Florence, and Venice. We have designed this 7-day journey to give you the perfect mix of history, art, and romance. From the ancient Colosseum to the rolling hills of Tuscany and the canals of Venice, you will see the absolute best of Italy in style and comfort.
        </p>
      </section>
      ...
      <section id="enquire" className="py-20 px-6 sm:px-12 max-w-[800px] mx-auto scroll-mt-24">
        <div className="bg-white p-8 sm:p-12 rounded-[2.5rem] border border-[#E6E8EF] shadow-xl text-center">
          <h2 className="text-3xl font-bold text-[#1F2328] mb-4">Like this Italy plan?</h2>
