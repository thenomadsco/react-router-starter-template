...
const PAGE_CONFIG = {
  ...
  heroSlides: [
    ...
    { label: "Scuba", alt: "Underwater Coral", src: "https://images.unsplash.com/photo-1582967788606-a171f1080ca8?q=80&w=1920&auto=format&fit=crop" },
  ],
  itinerary: [
    { day: "01", title: "Arrival in Port Blair", desc: "Arrive at Port Blair. Visit the historic Cellular Jail and witness the moving Light & Sound Show in the evening." },
    { day: "02", title: "Havelock Island", desc: "Take a private ferry to Havelock. Visit Radhanagar Beach, ranked as one of the best beaches in Asia." },
    { day: "03", title: "Elephant Beach & Water Sports", desc: "Boat ride to Elephant Beach for snorkeling and sea walking. The coral reefs here are vibrant and alive." },
    { day: "04", title: "Neil Island", desc: "Cruise to Neil Island. Visit the Natural Bridge and Laxmanpur Beach for a breathtaking sunset." },
    { day: "05", title: "Return to Port Blair", desc: "Return to Port Blair. Time for shopping and local exploration. Departure the next morning." },
  ],
};
