...
const PAGE_CONFIG = {
  ...
  itinerary: [
    ...
    { day: "02", title: "Bangkok City Tour", desc: "Visit the Grand Palace and Emerald Buddha Temple. Boat ride to Wat Arun. Shopping at MBK or ICONSIAM." },
    { day: "03", title: "Safari World", desc: "Full day at Safari World & Marine Park. See tigers, giraffes, and dolphin shows. Lunch included." },
    { day: "04", title: "Fly to Phuket", desc: "Transfer to airport for flight to Phuket. Check-in to beach resort. Evening free to explore Patong Beach." },
    { day: "05", title: "Phi Phi Islands", desc: "Speedboat tour to Phi Phi Islands. Visit Maya Bay, snorkel in clear waters, and enjoy a beachside lunch." },
    { day: "06", title: "James Bond Island", desc: "Cruise to Phang Nga Bay. Canoe through sea caves and mangroves. Visit the famous James Bond Island." },
    { day: "07", title: "Departure", desc: "Transfer to Phuket airport for the flight back home." },
  ],
};
