...
const PAGE_CONFIG = {
  ...
  heroSlides: [
    { label: "Hawa Mahal", alt: "Hawa Mahal Jaipur", src: "https://images.unsplash.com/photo-1599661046289-e31897846e41?q=80&w=1920&auto=format&fit=crop" },
  ...
  itinerary: [
    { day: "01", title: "Arrival in Jaipur", desc: "Welcome to the Pink City. Visit the City Palace and Jantar Mantar. Evening at Chokhi Dhani for Rajasthani cuisine." },
    { day: "02", title: "Amber Fort & Jodhpur", desc: "Morning elephant ride at Amber Fort. Drive to the Blue City, Jodhpur." },
    { day: "03", title: "Mehrangarh Fort", desc: "Explore the majestic Mehrangarh Fort and Jaswant Thada. Drive to Udaipur in the evening." },
    { day: "04", title: "Udaipur City", desc: "Visit the City Palace and Saheliyon Ki Bari. Sunset boat ride on Lake Pichola." },
    { day: "05", title: "Departure", desc: "Transfer to Udaipur airport for your onward journey." },
  ],
}; 
