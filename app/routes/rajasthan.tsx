...
const PAGE_CONFIG = {
  ...
  heroSlides: [
    ...
    {
      label: "Udaipur",
      alt: "Lake Pichola and City Palace",
      src: "https://images.unsplash.com/photo-1590050752117-238cb0fb12b1?q=80&w=1920&auto=format&fit=crop",
    },
    {
      label: "Jodhpur",
      alt: "Blue City Jodhpur",
      src: "https://images.unsplash.com/photo-1534759869506-644778393527?q=80&w=1920&auto=format&fit=crop",
    },
    {
      label: "Desert",
      alt: "Camels in desert",
      src: "https://images.unsplash.com/photo-1522209675870-8438b4df3cb2?q=80&w=1920&auto=format&fit=crop",
    },
  ],
  ...
  itinerary: [
    {
      ...
      desc: "Arrive in Jaipur and transfer to your heritage hotel. Visit the City Palace, a blend of Rajasthani and Mughal architecture, and the Jantar Mantar observatory. In the evening, witness the Albert Hall Museum all lit up or enjoy an authentic Rajasthani thali at Chokhi Dhani.",
    },
    {
      day: "02",
      title: "Jaipur Sightseeing",
      desc: "Start with a photo stop at Hawa Mahal (Palace of Winds). Proceed to the majestic Amber Fort, located on a hill. You can opt for an elephant ride up the fort ramparts. On the way back, see the Jal Mahal (Water Palace). Evening is free for shopping in the colorful bazaars of Jaipur.",
    },
    {
      day: "03",
      title: "Jaipur to Jodhpur – The Blue City",
      desc: "Drive to Jodhpur (approx 6 hours). Upon arrival, check in and relax. Jodhpur is famous for its blue-painted houses and the imposing fort that towers over the city. Enjoy a rooftop dinner with a view of the illuminated fort.",
    },
    {
      day: "04",
      title: "Mehrangarh Fort & Transfer to Udaipur",
      desc: "Visit Mehrangarh Fort, one of the largest forts in India, housing a splendid museum. Visit Jaswant Thada, a white marble cenotaph. In the afternoon, we drive to Udaipur, stopping at the stunning Ranakpur Jain Temples known for their 1,444 uniquely carved pillars.",
    },
    {
      day: "05",
      title: "Udaipur – The City of Lakes",
      desc: "Explore the romantic city of Udaipur. Visit the grand City Palace overlooking Lake Pichola. Walk through the Saheliyon Ki Bari (Garden of Maidens). In the evening, enjoy a boat ride on Lake Pichola, viewing the Jag Mandir and the famous Lake Palace. It is a magical experience.",
    },
    {
      day: "06",
      title: "Departure",
      desc: "After breakfast, you can visit the Vintage Car Museum or the Karni Mata Ropeway for city views. Transfer to Udaipur Airport for your onward journey, taking with you the royal memories of Rajasthan.",
    },
  ],
};
