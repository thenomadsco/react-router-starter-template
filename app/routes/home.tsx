...
const heroImages = [
  ...
  { url: "https://images.unsplash.com/photo-6MxxQJtDgak?auto=format&fit=crop&w=2000&q=80", label: "Santorini, Greece" },
  { url: "https://images.unsplash.com/photo-s68juqYE6PE?auto=format&fit=crop&w=2000&q=80", label: "Eiffel Tower, Paris" }
];
...
const destinations: Destination[] = [
  ...
  { id: 2, title: "Maldives", category: "International", image: "https://images.unsplash.com/photo-Uir7CQmmICM?auto=format&fit=crop&w=800&q=80", tags: ["Honeymoon", "Luxury", "Beaches"], description: "Overwater villas and crystal clear turquoise lagoons." },
  ...
  { id: 7, title: "Sri Lanka", category: "International", image: "https://images.unsplash.com/photo-ephEcDcyuqQ?auto=format&fit=crop&w=800&q=80", tags: ["Nature", "Wildlife", "Beaches"], description: "Diverse landscapes, wildlife, and ancient Buddhist ruins." },
  ...
  { id: 15, title: "USA", category: "International", image: "https://images.unsplash.com/photo-pbXbb6XlxLY?auto=format&fit=crop&w=800&q=80", tags: ["City", "Nature", "Diverse"], description: "Diverse experiences from bustling metropolises to vast national parks." },
  { id: 16, title: "South Africa", category: "International", image: "https://images.unsplash.com/photo-BFC_39NfWPI?auto=format&fit=crop&w=800&q=80", tags: ["Wildlife", "Adventure", "Nature"], description: "Safari adventures, stunning coastlines, and vibrant culture." },
  ...
  { id: 18, title: "Tanzania", category: "International", image: "https://images.unsplash.com/photo-a9iRFPAQcwk?auto=format&fit=crop&w=800&q=80", tags: ["Wildlife", "Safari", "Beaches"], description: "Mount Kilimanjaro, Serengeti safaris, and Zanzibar beaches." },
  ...
  { id: 21, title: "Himachal Pradesh", category: "India", image: "https://images.unsplash.com/photo-ctACgbxHf1I?auto=format&fit=crop&w=800&q=80", tags: ["Mountains", "Nature", "Adventure"], description: "Scenic hill stations, pine forests, and snow-capped peaks." },
  { id: 22, title: "Uttarakhand", category: "India", image: "https://images.unsplash.com/photo-CjECwmKED0c?auto=format&fit=crop&w=800&q=80", tags: ["Mountains", "Spiritual", "Nature"], description: "Land of Gods, featuring pilgrimage sites and Himalayan vistas." },
  ...
  { id: 26, title: "Andaman Islands", category: "India", image: "https://images.unsplash.com/photo-y4K3cK0YNnw?auto=format&fit=crop&w=800&q=80", tags: ["Beaches", "Islands", "Adventure"], description: "Pristine beaches, clear waters, and water sports." },
  { id: 27, title: "North East India", category: "India", image: "https://images.unsplash.com/photo-oqREr_NlCys?auto=format&fit=crop&w=800&q=80", tags: ["Nature", "Culture", "Offbeat"], description: "Unexplored beauty, tribal culture, and biodiversity." },
  { id: 28, title: "Sikkim", category: "India", image: "https://images.unsplash.com/photo-9GJrbQds35M?auto=format&fit=crop&w=800&q=80", tags: ["Mountains", "Nature", "Monasteries"], description: "Home to Kanchenjunga, scenic landscapes, and monasteries." },
  { id: 29, title: "Meghalaya", category: "India", image: "https://images.unsplash.com/photo-JIht7_aZ-ok?auto=format&fit=crop&w=800&q=80", tags: ["Nature", "Waterfalls", "Offbeat"], description: "Abode of Clouds, known for living root bridges and waterfalls." },
  { id: 30, title: "Arunachal Pradesh", category: "India", image: "https://images.unsplash.com/photo-BozkkQTkBQk?auto=format&fit=crop&w=800&q=80", tags: ["Mountains", "Culture", "Adventure"], description: "Land of the Dawn-Lit Mountains with rich tribal heritage." },
  { id: 31, title: "Karnataka", category: "India", image: "https://images.unsplash.com/photo-nQ8gl8C2WRY?auto=format&fit=crop&w=800&q=80", tags: ["History", "Nature", "Culture"], description: "Heritage sites like Hampi, coffee plantations in Coorg." },
  { id: 32, title: "Tamil Nadu", category: "India", image: "https://images.unsplash.com/photo-lPEkE_95vng?auto=format&fit=crop&w=800&q=80", tags: ["Culture", "Temples", "Beaches"], description: "Land of temples, rich culture, and coastal beauty." },
  { id: 33, title: "Pondicherry", category: "India", image: "https://images.unsplash.com/photo-qhfFZkBJWHo?auto=format&fit=crop&w=800&q=80", tags: ["Beaches", "French Colony", "Relaxation"], description: "A touch of French culture on the Indian coast." },
  { id: 34, title: "West Bengal", category: "India", image: "https://images.unsplash.com/photo-FGvTKbESZ7M?auto=format&fit=crop&w=800&q=80", tags: ["Culture", "History", "Mountains"], description: "Cultural richness of Kolkata to the tea gardens of Darjeeling." },
  { id: 35, title: "Odisha", category: "India", image: "https://images.unsplash.com/photo-qpABorArXso?auto=format&fit=crop&w=800&q=80", tags: ["Culture", "Temples", "Beaches"], description: "Known for its ancient temples, beaches, and tribal culture." },
  { id: 36, title: "Gujarat", category: "India", image: "https://images.unsplash.com/photo-sydPGLOKIpo?auto=format&fit=crop&w=800&q=80", tags: ["Culture", "Wildlife", "White Desert"], description: "Rann of Kutch, Asiatic Lions, and vibrant traditions." }
];
