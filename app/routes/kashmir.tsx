...
const PAGE_CONFIG = {
  ...
  itinerary: [
    ...
    { day: "05", title: "Srinagar Sightseeing", desc: "Dedicate the day to the famous Mughal Gardens, including Nishat Bagh and Shalimar Bagh. Visit the Shankaracharya Temple atop a hill for a bird's-eye view of the city. Evening at leisure for shopping." },
