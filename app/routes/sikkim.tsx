...
const PAGE_CONFIG = {
  ...
  heroSlides: [
    { label: "Tsomgo", alt: "Lake", src: "/images/slides/sikkim-1-800.webp", srcSet: "/images/slides/sikkim-1-800.webp 800w, /images/slides/sikkim-1-1400.webp 1400w" },
    { label: "Kanchenjunga", alt: "Mountain", src: "/images/slides/sikkim-2-800.webp", srcSet: "/images/slides/sikkim-2-800.webp 800w, /images/slides/sikkim-2-1400.webp 1400w" },
    { label: "Pelling", alt: "Skywalk", src: "/images/slides/sikkim-3-800.webp", srcSet: "/images/slides/sikkim-3-800.webp 800w, /images/slides/sikkim-3-1400.webp 1400w" },
    { label: "Tea", alt: "Temi Garden", src: "/images/slides/sikkim-4-800.webp", srcSet: "/images/slides/sikkim-4-800.webp 800w, /images/slides/sikkim-4-1400.webp 1400w" },
  ],
  itinerary: [
    ...
    { day: "02", title: "Tsomgo Lake & Baba Mandir", desc: "Excursion to the high-altitude Tsomgo Lake (12,400 ft) and Baba Harbhajan Singh Mandir. Enjoy a Yak ride by the lake which remains frozen in winter." },
    { day: "03", title: "Gangtok to Pelling", desc: "Drive to Pelling in West Sikkim. En route visit the Buddha Park at Ravangla. Pelling offers majestic close-up views of Mt. Kanchenjunga." },
    { day: "04", title: "Pelling Sightseeing", desc: "Walk on the Pelling Skywalk. Visit the ancient Pemayangtse Monastery and Rabdentse Ruins. Later, visit Khecheopalri Lake and Kanchenjunga Falls." },
    { day: "05", title: "Departure", desc: "Return drive to Bagdogra Airport for the flight home." },
  ],
};
