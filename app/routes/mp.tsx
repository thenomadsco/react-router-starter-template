...
const PAGE_CONFIG = {
  ...
  badge: "Wildlife & History",
  durationLabel: "5 Nights / 6 Days",
  visaLabel: "No Visa Required",
  seasonLabel: "Best: Oct - Mar",
  heroSlides: [
    { label: "Khajuraho", alt: "Temples", src: "/images/slides/mp-1-800.webp", srcSet: "/images/slides/mp-1-800.webp 800w, /images/slides/mp-1-1400.webp 1400w" },
    { label: "Kanha", alt: "Tiger", src: "/images/slides/mp-2-800.webp", srcSet: "/images/slides/mp-2-800.webp 800w, /images/slides/mp-2-1400.webp 1400w" },
    { label: "Bhedaghat", alt: "Marble Rocks", src: "/images/slides/mp-3-800.webp", srcSet: "/images/slides/mp-3-800.webp 800w, /images/slides/mp-3-1400.webp 1400w" },
    { label: "Sanchi", alt: "Stupa", src: "/images/slides/mp-4-800.webp", srcSet: "/images/slides/mp-4-800.webp 800w, /images/slides/mp-4-1400.webp 1400w" },
  ],
  itinerary: [
    { day: "01", title: "Arrival in Jabalpur", desc: "Arrive at Jabalpur. Excursion to Bhedaghat for a boat ride through the stunning Marble Rocks gorge on the Narmada River and a visit to Dhuandhar Falls." },
    { day: "02", title: "Transfer to Kanha", desc: "Drive to Kanha National Park, the inspiration for 'The Jungle Book'. Check into the jungle lodge. Evening at leisure for a nature walk or resort activities." },
    { day: "03", title: "Jungle Safari", desc: "Early morning Jeep Safari into the national park. Opportunity to spot the Royal Bengal Tiger, Barasingha, and other wildlife. Afternoon at leisure to enjoy the forest serenity." },
    { day: "04", title: "Kanha to Khajuraho", desc: "Proceed on a scenic drive to Khajuraho. Famous for its nagara-style architecture and sculptures. In the evening, attend the Light and Sound show at the temple complex." },
    { day: "05", title: "Khajuraho Temples", desc: "Tour the Western Group of Temples, a UNESCO World Heritage site, known for intricate stone carvings. Visit the Eastern group of Jain temples later in the day." },
    { day: "06", title: "Departure", desc: "Transfer to Khajuraho Airport/Station for the return journey." },
  ],
};
