...
const PAGE_CONFIG = {
  ...
  heroSlides: [
    { label: "Tsomgo Lake", alt: "Tsomgo Lake in Winter", src: "https://images.unsplash.com/photo-1631643171709-626f69ca8be0?q=80&w=1920&auto=format&fit=crop" },
    { label: "Kanchenjunga", alt: "Mountain Views", src: "https://images.unsplash.com/photo-1588252277025-27a39d42eb26?q=80&w=1920&auto=format&fit=crop" },
  ],
  itinerary: [
    { day: "01", title: "Arrival in Gangtok", desc: "Arrive at Bagdogra Airport. Scenic drive to Gangtok. Evening free at M.G. Marg." },
    { day: "02", title: "Tsomgo Lake & Baba Mandir", desc: "Excursion to the high-altitude Tsomgo Lake and Baba Harbhajan Singh Mandir. Yak ride by the lake." },
    { day: "03", title: "Gangtok to Pelling", desc: "Drive to Pelling. Visit Buddha Park at Ravangla on the way. Enjoy views of Mt. Kanchenjunga." },
    { day: "04", title: "Pelling Sightseeing", desc: "Visit the Skywalk, Pemayangtse Monastery, and Khecheopalri Lake." },
    { day: "05", title: "Departure", desc: "Drive back to Bagdogra for your flight home." },
  ],
};
