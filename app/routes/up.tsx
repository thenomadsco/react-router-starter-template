...
const PAGE_CONFIG = {
  ...
  heroSlides: [
    ...
    },
    {
      label: "Ayodhya",
      alt: "Ram Mandir vibe",
      src: "https://images.unsplash.com/photo-1619864273410-634626305a4b?q=80&w=1920&auto=format&fit=crop",
    },
    {
      label: "Lucknow",
      alt: "Rumi Darwaza",
      src: "https://images.unsplash.com/photo-1588824367399-c092923cb99c?q=80&w=1920&auto=format&fit=crop",
    },
  ],
  ...
  itinerary: [
    {
      day: "01",
      title: "Arrival in Varanasi – The Eternal City",
      desc: "Arrive at Varanasi Airport. Transfer to your hotel. In the evening, proceed to the Dashashwamedh Ghat to witness the world-famous Ganga Aarti. The synchronized chanting, fire, and incense create a mesmerizing spiritual atmosphere.",
    },
    {
      day: "02",
      title: "Sarnath & Boat Ride",
      desc: "Early morning boat ride on the Ganges to see the sunrise and the ghats coming to life. Visit the Kashi Vishwanath Temple. Later, excursion to Sarnath, where Lord Buddha gave his first sermon. See the Dhamek Stupa and the Ashoka Pillar.",
    },
    {
      day: "03",
      title: "Varanasi to Ayodhya",
      desc: "Drive or take a train to Ayodhya, the birthplace of Lord Rama. Visit the magnificent Ram Janmabhoomi Temple. Explore Hanuman Garhi and Kanak Bhawan. The spiritual energy of this ancient city is palpable.",
    },
    {
      day: "04",
      title: "Ayodhya to Agra",
      desc: "Travel to Agra (via Lucknow expressway). Upon arrival, check in. In the evening, visit the Agra Fort, a massive red sandstone fortification. From here, you get your first view of the Taj Mahal in the distance.",
    },
    {
      day: "05",
      title: "The Taj Mahal & Departure",
      desc: "Visit the Taj Mahal at sunrise when the marble glows pink and golden. This monument of love is a breathtaking sight. Return to the hotel for breakfast. Transfer to Delhi Airport or Agra Station for your onward journey.",
    },
  ],
};
