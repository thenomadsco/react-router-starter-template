...
const PAGE_CONFIG = {
  ...
  heroSlides: [
    { label: "Alleppey", alt: "Houseboat in Backwaters", src: "https://images.unsplash.com/photo-1602216056096-3b40cc0c9944?q=80&w=1920&auto=format&fit=crop" },
  ...
  itinerary: [
    { day: "01", title: "Arrival in Kochi", desc: "Arrive at Cochin Airport. Transfer to Munnar, enjoying the scenic drive through tea plantations and waterfalls." },
    { day: "02", title: "Munnar Sightseeing", desc: "Visit Eravikulam National Park to see the Nilgiri Tahr. Explore the Tea Museum and Mattupetty Dam." },
    { day: "03", title: "Thekkady Wildlife", desc: "Drive to Thekkady. Enjoy a boat cruise on Periyar Lake to spot wild elephants and diverse bird life." },
    { day: "04", title: "Alleppey Houseboat", desc: "Check into a traditional Houseboat. Cruise through the serene backwaters, enjoying freshly cooked Kerala cuisine on board." },
    { day: "05", title: "Departure", desc: "Disembark from the houseboat and transfer to Cochin Airport for your flight back home." },
  ],
};
