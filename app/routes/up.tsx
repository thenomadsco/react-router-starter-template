...
const PAGE_CONFIG = {
  ...
  heroSlides: [
    { label: "Varanasi", alt: "Ganga Aarti Varanasi", src: "https://images.unsplash.com/photo-1561361513-2d000a50f0dc?q=80&w=1920&auto=format&fit=crop" },
    { label: "Taj Mahal", alt: "Taj Mahal Agra", src: "https://images.unsplash.com/photo-1564507592333-c60657eea523?q=80&w=1920&auto=format&fit=crop" },
  ],
  itinerary: [
    { day: "01", title: "Arrival in Varanasi", desc: "Arrive in the spiritual capital. Witness the mesmerizing Ganga Aarti at Dashashwamedh Ghat in the evening." },
    { day: "02", title: "Sarnath & Temple Tour", desc: "Morning boat ride on the Ganges. Visit Sarnath where Buddha gave his first sermon and Kashi Vishwanath Temple." },
    { day: "03", title: "Ayodhya", desc: "Drive to Ayodhya. Visit the Ram Janmabhoomi Temple and Hanuman Garhi." },
    { day: "04", title: "Lucknow/Agra", desc: "Drive to Agra. Visit the Agra Fort and sunset view of the Taj Mahal." },
    { day: "05", title: "The Taj & Departure", desc: "Sunrise visit to the magnificent Taj Mahal. Transfer to Delhi/Airport for departure." },
  ],
};
