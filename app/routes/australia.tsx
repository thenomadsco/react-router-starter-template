...
const PAGE_CONFIG = {
  ...
  heroSlides: [
    { label: "Opera House", alt: "Sydney", src: "https://images.unsplash.com/photo-1506973035872-a4ec16b8e8d9?q=80&w=1920&auto=format&fit=crop" },
    { label: "Gold Coast", alt: "Skyline", src: "https://images.unsplash.com/photo-1533230985-7973d0947690?q=80&w=1920&auto=format&fit=crop" },
    { label: "Ocean Road", alt: "Apostles", src: "https://images.unsplash.com/photo-1510143110294-f442f4b00574?q=80&w=1920&auto=format&fit=crop" },
    { label: "Wildlife", alt: "Kangaroo", src: "https://images.unsplash.com/photo-1528026732386-8a71569655d4?q=80&w=1920&auto=format&fit=crop" },
  ],
  itinerary: [
    { day: "01", title: "Arrival in Sydney", desc: "Arrive in Sydney. Transfer to hotel. Evening at Darling Harbour." },
    { day: "02", title: "Sydney Icons", desc: "Tour the Opera House, Harbour Bridge, and Bondi Beach. Explore The Rocks." },
    { day: "03", title: "Blue Mountains", desc: "Day trip to Blue Mountains. Scenic World rides and Three Sisters view. Featherdale Wildlife Park." },
    { day: "04", title: "Fly to Gold Coast", desc: "Flight to Gold Coast. Check-in at Surfers Paradise. Evening beach walk." },
    { day: "05", title: "Theme Parks", desc: "Full day at Movie World or Sea World. Thrill rides and shows." },
    { day: "06", title: "Jet Boat & Hinterland", desc: "Jet boat ride. Afternoon visit to Mt. Tamborine for rainforest walks." },
    { day: "07", title: "Departure", desc: "Transfer to Brisbane/Gold Coast airport for return flight." },
  ],
};
