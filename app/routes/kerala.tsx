...
const PAGE_CONFIG = {
  ...
  heroSlides: [
    {
      label: "Alleppey",
      alt: "Houseboat cruising in Backwaters",
    ...
    {
      label: "Kochi",
      alt: "Chinese Fishing Nets at sunset",
      src: "https://images.unsplash.com/photo-1590636906232-446757c3df90?q=80&w=1920&auto=format&fit=crop",
    },
    {
      label: "Kathakali",
      alt: "Traditional Kathakali Dancer",
      src: "https://images.unsplash.com/photo-1598188207908-4682c7324748?q=80&w=1920&auto=format&fit=crop",
    },
  ],
  ...
  itinerary: [
    {
      ...
      desc: "Arrive at Cochin International Airport. Our driver will pick you up for a scenic 4-hour drive to Munnar. En route, stop at the Cheeyappara and Valara waterfalls. Watch the landscape change from coastal coconut palms to rolling hills of tea. Check into your resort and enjoy the cool misty evening.",
    },
    {
      day: "02",
      title: "Munnar Sightseeing",
      desc: "After breakfast, we visit Eravikulam National Park to spot the endangered Nilgiri Tahr. Visit the Tea Museum to understand the history of tea in Kerala. Later, head to Mattupetty Dam and Echo Point for boating. The lush green carpet of tea plantations offers endless photo opportunities.",
    },
    {
      day: "03",
      title: "Munnar to Thekkady",
      desc: "Drive to Thekkady (Periyar), famous for its wildlife sanctuary. In the evening, enjoy a boat cruise on Periyar Lake. If you are lucky, you might spot herds of wild elephants drinking by the water. You can also opt for a Kalaripayattu (martial arts) show in the evening.",
    },
    {
      day: "04",
      title: "Thekkady to Alleppey Houseboat",
      desc: "The highlight of your trip! We drive to Alleppey to board your private traditional Houseboat. Cruise slowly through the tranquil backwaters, passing by paddy fields and village life. Enjoy authentic Kerala cuisine (Karimeen fish fry is a must!) prepared fresh on the boat. Anchor for the night under the stars.",
    },
    {
      day: "05",
      title: "Departure from Kochi",
      desc: "Wake up to a sunrise over the water. Disembark from the houseboat after breakfast and drive back to Kochi. Depending on your flight time, we can visit the Fort Kochi area to see the Chinese Fishing Nets and St. Francis Church before dropping you at the airport.",
    },
  ],
};
