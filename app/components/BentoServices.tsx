    ...
    >
      {arr.map((_, i) => (
        <motion.div
          ...
          className="flex flex-row rounded-full border border-neutral-100 dark:border-white/[0.1] p-2 items-center space-x-2 bg-neutral-50 dark:bg-black w-full h-4"
        ></motion.div>
      ))}
    </motion.div>
  );
...
const SkeletonFour = () => {
  ...
  return (
    ...
    >
      <motion.div
        variants={first}
        className="h-full w-1/3 rounded-2xl bg-white dark:bg-black p-4 dark:border-white/[0.1] border border-neutral-200 flex flex-col items-center justify-center"
      >
        <div className="h-10 w-10 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 flex-shrink-0" />
        <p className="sm:text-sm text-xs text-center font-semibold text-neutral-500 mt-4">
          Personalized Itineraries
        </p>
        <p className="border border-red-500 bg-red-100 dark:bg-red-900/20 text-red-600 text-[10px] rounded-full px-2 py-0.5 mt-4">
          Custom
        </p>
      </motion.div>
      <motion.div className="h-full relative z-20 w-1/3 rounded-2xl bg-white dark:bg-black p-4 dark:border-white/[0.1] border border-neutral-200 flex flex-col items-center justify-center">
        <div className="h-10 w-10 rounded-full bg-gradient-to-r from-blue-500 to-cyan-500 flex-shrink-0" />
        <p className="sm:text-sm text-xs text-center font-semibold text-neutral-500 mt-4">
          Local Experiences
        </p>
        <p className="border border-green-500 bg-green-100 dark:bg-green-900/20 text-green-600 text-[10px] rounded-full px-2 py-0.5 mt-4">
          Curated
        </p>
      </motion.div>
      <motion.div
      ...
      >
        ...
        <p className="border border-orange-500 bg-orange-100 dark:bg-orange-900/20 text-orange-600 text-[10px] rounded-full px-2 py-0.5 mt-4">
          Verified
        </p>
      </motion.div>
    </motion.div>
...
const SkeletonFive = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="h-10 w-10 rounded-full bg-gradient-to-r from-white to-slate-400 flex-shrink-0" />
      ...
      >
        <p className="text-xs text-neutral-500">Always here.</p>
        <div className="h-6 w-6 rounded-full bg-gradient-to-r from-white to-slate-200 flex-shrink-0" />
      </motion.div>
    </motion.div>
  );
};
