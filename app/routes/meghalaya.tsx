...
const PAGE_CONFIG = {
  ...
  heroSlides: [
    { label: "Root Bridges", alt: "Living Root Bridge", src: "https://images.unsplash.com/photo-1591016422238-63cb5fb5ca50?q=80&w=1920&auto=format&fit=crop" },
    { label: "Dawki River", alt: "Crystal Clear River", src: "https://images.unsplash.com/photo-1589379677465-b7787373ae4a?q=80&w=1920&auto=format&fit=crop" },
  ],
  itinerary: [
    { day: "01", title: "Arrival in Shillong", desc: "Arrive at Guwahati and drive to Shillong. Stop at Umiam Lake for a beautiful sunset view." },
    { day: "02", title: "Cherrapunji", desc: "Visit the wettest place on earth. See Nohkalikai Falls, Seven Sisters Falls, and Mawsmai Cave." },
    { day: "03", title: "Living Root Bridges", desc: "Trek to the Double Decker Living Root Bridge in Nongriat (for active travelers) or visit the single root bridge." },
    { day: "04", title: "Dawki & Mawlynnong", desc: "Visit Dawki for a boat ride on the crystal clear Umngot River. Visit Mawlynnong, Asia's cleanest village." },
    { day: "05", title: "Departure", desc: "Drive back to Guwahati Airport with memories of the misty hills." },
  ],
};
