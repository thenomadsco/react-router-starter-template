...
const PAGE_CONFIG = {
  ...
  visaLabel: "Permit Required (Assisted)",
  seasonLabel: "Best: Mar - Jun",

  heroSlides: [
    {
      label: "Tsomgo Lake",
      alt: "Frozen Tsomgo Lake",
      src: "https://images.unsplash.com/photo-1631643171709-626f69ca8be0?q=80&w=1920&auto=format&fit=crop",
    },
    {
      label: "Kanchenjunga",
      alt: "Mt Kanchenjunga view",
      src: "https://images.unsplash.com/photo-1588252277025-27a39d42eb26?q=80&w=1920&auto=format&fit=crop",
    },
    {
      label: "Pelling",
      alt: "Skywalk Pelling",
      src: "https://images.unsplash.com/photo-1626129883907-275d3c73335e?q=80&w=1920&auto=format&fit=crop",
    },
    {
      label: "Tea Garden",
      alt: "Temi Tea Garden",
      src: "https://images.unsplash.com/photo-1622364718420-1da2ce67cb2a?q=80&w=1920&auto=format&fit=crop",
    },
  ],
  ...
  itinerary: [
    {
      ...
      desc: "Arrive at Bagdogra Airport (WB). A scenic 4-5 hour drive takes you along the Teesta River to Gangtok, the capital of Sikkim. Check in and spend the evening strolling on the famous M.G. Marg, a vehicle-free promenade full of cafes and shops.",
    },
    {
      day: "02",
      title: "Tsomgo Lake & Baba Mandir",
      desc: "Excursion to Tsomgo Lake at 12,400 ft. In winter, the lake is frozen; in summer, it reflects the surrounding peaks. You can ride a Yak here. Visit the Baba Harbhajan Singh Mandir. Return to Gangtok.",
    },
    {
      day: "03",
      title: "Gangtok to Pelling",
      desc: "Drive to Pelling in West Sikkim. On the way, visit the Buddha Park at Ravangla featuring a massive 130ft Buddha statue. Pelling offers the closest and most majestic views of Mt. Kanchenjunga.",
    },
    {
      day: "04",
      title: "Pelling Sightseeing",
      desc: "Walk on the Pelling Skywalk, a glass-bottomed bridge. Visit the ancient Pemayangtse Monastery and the Rabdentse Ruins (ancient capital). In the afternoon, visit the holy Khecheopalri Lake and Kanchenjunga Falls.",
    },
    {
      day: "05",
      title: "Return to Siliguri/Bagdogra",
      desc: "After breakfast, start your return drive to Siliguri or Bagdogra. Stay overnight near the airport or depart late in the evening if flights allow.",
    },
  ],
};
