...
const PAGE_CONFIG = {
  ...
  heroSlides: [
    { label: "Rome", alt: "Colosseum", src: "https://images.unsplash.com/photo-1552832230-c0197dd311b5?q=80&w=1920&auto=format&fit=crop" },
    { label: "Venice", alt: "Canals", src: "https://images.unsplash.com/photo-1514890547357-a9ee288728e0?q=80&w=1920&auto=format&fit=crop" },
    { label: "Florence", alt: "Duomo", src: "https://images.unsplash.com/photo-1543997385-d72db621e25d?q=80&w=1920&auto=format&fit=crop" },
    { label: "Amalfi", alt: "Coast", src: "https://images.unsplash.com/photo-1533904353181-255e0a3b05f2?q=80&w=1920&auto=format&fit=crop" },
  ],
  itinerary: [
    ...
    { day: "02", title: "Ancient Rome & Vatican", desc: "Tour the Colosseum and Roman Forum. Visit the Vatican City to see St. Peter's Basilica and the Sistine Chapel masterpieces." },
    { day: "03", title: "Florence via Train", desc: "High-speed train to Florence. Explore the Renaissance city, seeing the Duomo and Ponte Vecchio. Sunset at Piazzale Michelangelo." },
    { day: "04", title: "Pisa & Tuscany", desc: "Excursion to Pisa to hold up the Leaning Tower. Drive through the rolling hills and vineyards of the Tuscan countryside." },
    { day: "05", title: "Venice - The Floating City", desc: "Train to Venice. Arrive by private water taxi. Enjoy a romantic Gondola ride through the canals and visit St. Mark's Square." },
    { day: "06", title: "Murano & Burano", desc: "Boat tour to the islands of Murano (glass blowing) and Burano (lace and colorful houses). Farewell dinner in Venice." },
    { day: "07", title: "Departure", desc: "Water transfer to Marco Polo Airport for the flight home." },
  ],
};
