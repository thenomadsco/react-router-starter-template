...
const PAGE_CONFIG = {
  ...
  heroSlides: [
    { label: "Manali", alt: "Snowy Mountains Manali", src: "https://images.unsplash.com/photo-1626621341517-bbf3d9990a23?q=80&w=1920&auto=format&fit=crop" },
    { label: "Shimla", alt: "Shimla Ridge", src: "https://images.unsplash.com/photo-1562649846-ab413ca01712?q=80&w=1920&auto=format&fit=crop" },
  ],
  itinerary: [
    { day: "01", title: "Arrival in Shimla", desc: "Drive from Chandigarh/Delhi to Shimla. Evening walk on the Mall Road and The Ridge." },
    { day: "02", title: "Kufri & Sightseeing", desc: "Visit Kufri for panoramic views. Visit Jakhu Temple and Christ Church." },
    { day: "03", title: "Drive to Manali", desc: "Scenic drive to Manali via Kullu. Enjoy river rafting in Kullu (optional)." },
    { day: "04", title: "Solang Valley", desc: "Excursion to Solang Valley. Enjoy paragliding, ATV rides, and snow activities (in winter)." },
    { day: "05", title: "Manali Local", desc: "Visit Hadimba Temple, Vashisht Hot Springs, and Old Manali cafes." },
    { day: "06", title: "Departure", desc: "Drive back to Chandigarh/Delhi for your return journey." },
  ],
};
