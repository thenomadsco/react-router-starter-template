...
const PAGE_CONFIG = {
  ...
  heroSlides: [
    { label: "Villas", alt: "Water Villas", src: "/images/slides/maldives-1-800.webp", srcSet: "/images/slides/maldives-1-800.webp 800w, /images/slides/maldives-1-1400.webp 1400w" },
    { label: "Lagoon", alt: "Turquoise Water", src: "/images/slides/maldives-2-800.webp", srcSet: "/images/slides/maldives-2-800.webp 800w, /images/slides/maldives-2-1400.webp 1400w" },
    { label: "Reef", alt: "Snorkeling", src: "/images/slides/maldives-3-800.webp", srcSet: "/images/slides/maldives-3-800.webp 800w, /images/slides/maldives-3-1400.webp 1400w" },
    { label: "Sunset", alt: "Cruise", src: "/images/slides/maldives-4-800.webp", srcSet: "/images/slides/maldives-4-800.webp 800w, /images/slides/maldives-4-1400.webp 1400w" },
  ],
  itinerary: [
    { day: "01", title: "Arrival in Paradise", desc: "Land at Male Airport and transfer via speedboat or seaplane to the island resort. Welcome drink and check-in to the beach or water villa." },
    { day: "02", title: "Leisure & Beach", desc: "Day at leisure to enjoy the white sandy beaches. Swim in the turquoise lagoon or relax at the infinity pool." },
    { day: "03", title: "Water Sports & Snorkeling", desc: "Explore the vibrant coral reefs with a snorkeling trip. Optional water sports like kayaking, jet-skiing, or windsurfing." },
    { day: "04", title: "Spa & Sunset Cruise", desc: "Indulge in a relaxing spa treatment. In the evening, enjoy a romantic sunset dolphin cruise followed by a candlelit dinner." },
    { day: "05", title: "Departure", desc: "Enjoy a final breakfast with ocean views. Transfer back to Male Airport for the return flight." },
  ],
};
