...
const PAGE_CONFIG = {
  ...
  heroSlides: [
    { label: "Rann of Kutch", alt: "White Desert", src: "https://images.unsplash.com/photo-1642841819300-20ed449c02a1?q=80&w=1920&auto=format&fit=crop" },
    { label: "Statue of Unity", alt: "Statue of Unity", src: "https://images.unsplash.com/photo-1598886367332-90f7d468eb37?q=80&w=1920&auto=format&fit=crop" },
  ],
  itinerary: [
    { day: "01", title: "Arrival in Ahmedabad", desc: "Arrive in Ahmedabad. Visit Sabarmati Ashram and the Adalaj Stepwell. Evening at Kankaria Lake." },
    { day: "02", title: "Statue of Unity", desc: "Day trip to Kevadia to see the world's tallest statue, the Statue of Unity. Laser show in the evening." },
    { day: "03", title: "Rann of Kutch", desc: "Drive to the White Rann. Experience the Rann Utsav (in season) and the mesmerizing white salt desert sunset." },
    { day: "04", title: "Kutch Exploration", desc: "Visit Kala Dungar for panoramic views and local artisan villages for handicrafts." },
    { day: "05", title: "Departure", desc: "Return to Ahmedabad/Bhuj for departure." },
  ],
};
