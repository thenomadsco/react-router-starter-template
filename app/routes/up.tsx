...
const PAGE_CONFIG = {
  ...
  heroSlides: [
    { label: "Varanasi", alt: "Ghats", src: "https://images.unsplash.com/photo-1561361513-2d000a50f0dc?q=80&w=1920&auto=format&fit=crop" },
    { label: "Agra", alt: "Taj Mahal", src: "https://images.unsplash.com/photo-1564507592333-c60657eea523?q=80&w=1920&auto=format&fit=crop" },
    { label: "Ayodhya", alt: "Ram Mandir", src: "https://images.unsplash.com/photo-1619864273410-634626305a4b?q=80&w=1920&auto=format&fit=crop" },
    { label: "Lucknow", alt: "Rumi Darwaza", src: "https://images.unsplash.com/photo-1588824367399-c092923cb99c?q=80&w=1920&auto=format&fit=crop" },
  ],
  itinerary: [
    ...
    { day: "02", title: "Sarnath & Temple Tour", desc: "Sunrise boat ride on the Ganges to see the ghats come alive. Visit Kashi Vishwanath Temple. Excursion to Sarnath, the site of Lord Buddha's first sermon, to see the Dhamek Stupa and museum." },
    { day: "03", title: "Varanasi to Ayodhya", desc: "Travel to Ayodhya. Visit the magnificent Ram Janmabhoomi Temple, Hanuman Garhi, and Kanak Bhawan. Experience the deep spiritual energy of this ancient city." },
    { day: "04", title: "Ayodhya to Agra", desc: "Drive to Agra. Visit the massive red sandstone Agra Fort. Catch a glimpse of the Taj Mahal from the fort premises in the evening." },
    { day: "05", title: "The Taj Mahal & Departure", desc: "Sunrise visit to the Taj Mahal to see the marble monument glow in the morning light. Transfer to Delhi Airport or Agra Station for the onward journey." },
  ],
};
