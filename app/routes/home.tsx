...
export const getResponsiveUrls = (url: string) => {
  if (url.includes("/images/hero/") && url.endsWith("-800.webp")) {
    const url1400 = url.replace("-800.webp", "-1400.webp");
    return { src: url, srcSet: `${url} 800w, ${url1400} 1400w` };
  }
...
export const destinations: Destination[] = [
  ...
  },
  {
    ...
    description: "Milford Sound from a boat. Bungee jumping in Queenstown. Hobbiton if you loved the films, stargazing in Tekapo if you didn't. The people who go come back saying it was the most beautiful place they've seen. Getting here from India takes effort, but they are never wrong about it.",
    ...
    <section className="relative min-h-[95vh] flex items-center justify-center w-full bg-[#1F2328] overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-8 relative flex flex-col items-center text-center z-20 pt-32 pb-10">
        ...
        <p className="animate-hero-3 text-lg md:text-xl text-white/80 mb-12 max-w-xl leading-relaxed drop-shadow-md">
          Zero-stress premium travel planning. We handle every detail so you collect the memories.
        </p>
    ...
    <div className="min-h-screen bg-white text-gray-900 font-sans overflow-x-hidden">
      ...
      <nav className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? "bg-white/90 backdrop-blur-md py-4 shadow-sm" : "bg-transparent py-6"}`}>
        <div className="container mx-auto px-4 md:px-8 flex justify-between items-center gap-2 min-w-0">
          ...
          <button aria-label="Open navigation menu" className={`md:hidden z-50 p-2 transition-colors ${isMenuOpen || scrolled ? "text-gray-900" : "text-white"}`} onClick={() => setIsMenuOpen(!isMenuOpen)}>
          ...
          <RevealOnScroll>
            ...
            >
              <img
                ...
                srcSet="/images/hero/banner-800.webp 800w, /images/hero/banner-1400.webp 1400w"
            ...
            {testimonials.map((t) => (
              <RevealOnScroll key={t.id}>
                <div className="bg-white p-10 rounded-[2.5rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgb(0,0,0,0.08)] hover:-translate-y-2 transition-all duration-500 h-full flex flex-col relative overflow-hidden">
                  ...
                  <div>
                    <h3 className="font-bold text-xl text-[#1F2328]">{t.name}</h3>
      ...
      <section id="contact" className="py-32 px-6 sm:px-12 bg-white relative overflow-hidden">
        <div className="max-w-[1200px] mx-auto text-center mb-16">
          ...
          <p className="text-xl text-[#1F2328] max-w-2xl mx-auto">We are ready to craft your perfect trip. Choose how you'd like to reach us.</p>
        </div>
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-16">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-400 pr-6 leading-relaxed mb-10 text-lg">Planned personally by Kirti Shah. Every trip, every detail, every memory. Based in Vadodara, Gujarat.</p>
              <div className="flex space-x-4">
                ...
                <a href="mailto:thenomadsco@gmail.com" aria-label="Email us" className="w-12 h-12 bg-white/10 rounded-full flex items-center justify-center hover:bg-[#2D3191] hover:scale-110 transition-all duration-300"><Mail className="w-5 h-5" /></a>
              </div>
            </div>
            <div>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-300 uppercase tracking-widest mb-8">Legal</h4>
              <ul className="space-y-4 font-medium text-gray-300">
