...
const PAGE_CONFIG = {
  ...
  heroSlides: [
    { label: "Palolem", alt: "Goa Beach Sunset", src: "https://images.unsplash.com/photo-1512343879784-a960bf40e7f2?q=80&w=1920&auto=format&fit=crop" },
    { label: "Churches", alt: "Old Goa Church", src: "https://images.unsplash.com/photo-1587595431973-160d0d94add1?q=80&w=1920&auto=format&fit=crop" },
  ],
  itinerary: [
    { day: "01", title: "Arrival & North Goa", desc: "Arrive in Goa. Transfer to your resort. Spend the evening at Calangute or Baga beach enjoying the shacks." },
    { day: "02", title: "North Goa Tour", desc: "Visit Fort Aguada, Chapora Fort (Dil Chahta Hai fame), and Vagator Beach. Enjoy water sports." },
    { day: "03", title: "South Goa & History", desc: "Visit the UNESCO churches of Old Goa. Relax at the quieter Colva or Palolem beaches in the South." },
    { day: "04", title: "Departure", desc: "Enjoy a final dip in the pool or some souvenir shopping before heading to the airport." },
  ],
};
