...
const PAGE_CONFIG = {
  ...
  heroSlides: [
    { label: "Havelock", alt: "Radhanagar Beach", src: "/images/slides/andaman-1-800.webp", srcSet: "/images/slides/andaman-1-800.webp 800w, /images/slides/andaman-1-1400.webp 1400w" },
    { label: "Scuba", alt: "Coral Reefs", src: "/images/slides/andaman-2-800.webp", srcSet: "/images/slides/andaman-2-800.webp 800w, /images/slides/andaman-2-1400.webp 1400w" },
    { label: "Jail", alt: "Cellular Jail", src: "/images/slides/andaman-3-800.webp", srcSet: "/images/slides/andaman-3-800.webp 800w, /images/slides/andaman-3-1400.webp 1400w" },
    { label: "Neil", alt: "Natural Bridge", src: "/images/slides/andaman-4-800.webp", srcSet: "/images/slides/andaman-4-800.webp 800w, /images/slides/andaman-4-1400.webp 1400w" },
  ],
  itinerary: [
    { day: "01", title: "Arrival in Port Blair", desc: "Arrive in Port Blair and transfer to the hotel. Visit the historic Cellular Jail (Kala Pani) to pay respects to freedom fighters. In the evening, witness the Light & Sound Show narrating India's freedom struggle saga." },
    { day: "02", title: "Havelock Island", desc: "Take a private luxury ferry to Havelock Island. Proceed to Radhanagar Beach, consistently ranked among Asia's best beaches. Its white sands and turquoise waters offer a perfect setting for swimming." },
    { day: "03", title: "Elephant Beach Excursion", desc: "Speedboat ride to Elephant Beach, known for vibrant coral reefs. Indulge in water activities like snorkeling, sea walking, or glass-bottom boat rides. The underwater marine life here is spectacular." },
    { day: "04", title: "Neil Island", desc: "Cruise to Neil Island. Visit the Natural Bridge, a unique rock formation created by the sea. Later, relax at Laxmanpur Beach to watch a breathtaking sunset. The island offers a relaxed, rustic vibe." },
    { day: "05", title: "Return to Port Blair", desc: "Morning at Bharatpur Beach in Neil Island before taking the ferry back to Port Blair. Evening at leisure to explore the local market for shell handicrafts or visit the Anthropological Museum." },
    { day: "06", title: "Departure", desc: "Transfer to Veer Savarkar International Airport for the flight back home, carrying sun-kissed memories of the islands." },
  ],
};
