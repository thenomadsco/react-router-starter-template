  ...
  return (
    <div
      className={cn(
        ...
        className?.includes("bg-") ? "" : "bg-[#ececed]",
        className
      )}
    >
      {header}
      <div className="group-hover/bento:translate-x-2 transition duration-200">
        {icon}
        <div className="font-sans font-bold text-black mb-2 mt-2">
          {title}
        </div>
        <div className="font-sans font-normal text-black text-xs leading-relaxed">
          {description}
        </div>
      </div>
    </div>
