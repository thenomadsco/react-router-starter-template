      ...
      <div className="max-w-[800px] mx-auto text-center">
        ...
        <form action="https://formsubmit.co/thenomadsco@gmail.com" method="POST" className="space-y-4 text-left">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <label htmlFor="fr-name" className="sr-only">Full Name</label><input id="fr-name" type="text" name="name" required placeholder="Name" className="w-full px-4 py-3 bg-white rounded-xl border border-[#E6E8EF]" />
            <label htmlFor="fr-phone" className="sr-only">Phone Number</label><input id="fr-phone" type="tel" name="phone" required placeholder="Phone Number" className="w-full px-4 py-3 bg-white rounded-xl border border-[#E6E8EF]" />
          </div>
