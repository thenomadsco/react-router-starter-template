...
const PAGE_CONFIG = {
  ...
  itinerary: [
    ...
    { day: "02", title: "Tokyo Highlights", desc: "Visit Asakusa Senso-ji Temple, teamLab Borderless, and the famous Shibuya Crossing." },
    { day: "03", title: "Mt. Fuji & Hakone", desc: "Day trip to Mt. Fuji 5th station. Lake Ashi cruise and ropeway in Hakone. Return to Tokyo." },
    { day: "04", title: "Bullet Train to Kyoto", desc: "Shinkansen ride to Kyoto. Visit Golden Pavilion and Fushimi Inari Shrine gates." },
    { day: "05", title: "Nara & Osaka", desc: "Visit Nara Deer Park. Proceed to Osaka. Evening street food tour in Dotonbori." },
    { day: "06", title: "Universal Studios", desc: "Full day at Universal Studios Japan (Nintendo World & Harry Potter). Farewell dinner." },
    { day: "07", title: "Departure", desc: "Transfer to Kansai Airport (Osaka) for departure." },
  ],
};
