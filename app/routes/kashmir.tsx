...
const PAGE_CONFIG = {
  ...
  heroSlides: [
    { label: "Dal Lake", alt: "Shikara on Dal Lake", src: "https://images.unsplash.com/photo-1632231065530-f5fd55c62846?q=80&w=1920&auto=format&fit=crop" },
    ...
    { label: "Pahalgam", alt: "Pahalgam Valley", src: "https://images.unsplash.com/photo-1595842827763-71775e378393?q=80&w=1920&auto=format&fit=crop" },
  ],
  itinerary: [
    { day: "01", title: "Arrival in Srinagar", desc: "Welcome to Paradise. On arrival at Srinagar Airport, transfer to your Deluxe Houseboat. Enjoy a romantic Shikara ride on Dal Lake at sunset." },
    { day: "02", title: "Srinagar to Gulmarg", desc: "Drive to Gulmarg, the 'Meadow of Flowers'. Enjoy the world's highest cable car ride (Gondola) to witness snow-capped peaks. Return to Srinagar." },
    { day: "03", title: "Srinagar to Pahalgam", desc: "Visit Pahalgam, the 'Valley of Shepherds'. Visit Betaab Valley and Chandanwari. The scenic drive through saffron fields is mesmerizing." },
    { day: "04", title: "Sonamarg Day Trip", desc: "Excursion to Sonamarg, the 'Meadow of Gold'. Enjoy a pony ride to Thajiwas Glacier where snow remains round the year." },
    { day: "05", title: "Departure", desc: "After breakfast, visit the famous Mughal Gardens (Nishat & Shalimar) before transferring to the airport." },
  ],
};
