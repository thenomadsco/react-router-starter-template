...
const destinations: Destination[] = [
  ...
  { id: 8,  title: "Bhutan",               category: "International", image: "https://images.unsplash.com/photo-1548013146-72479768bada?auto=format&fit=crop&w=600&q=80",                        tags: ["Mountains","Culture","Peace"],          description: "The last great Himalayan kingdom, shrouded in mystery." },
  ...
  { id: 17, title: "Kenya",                category: "International", image: "https://images.unsplash.com/photo-1508675801627-066ac4346a55?auto=format&fit=crop&w=600&q=80",                        tags: ["Wildlife","Safari","Nature"],           description: "Home of the Great Migration and iconic African wildlife." },
  { id: 18, title: "Tanzania",             category: "International", image: "https://unsplash.com/photos/elephants-in-the-wild-dylb4XvOX-M/download?force=true",                        tags: ["Wildlife","Safari","Beaches"],          description: "Mount Kilimanjaro, Serengeti safaris, and Zanzibar beaches." },

  // ── INDIA ──────────────────────────────────────────────────────────────────
  { id: 19, title: "Kashmir",              category: "India",         image: "https://unsplash.com/photos/person-standing-on-rock-near-lake-and-mountain-range-AB5Is4yp618/download?force=true",                        tags: ["Mountains","Nature","Romance"],         description: "Paradise on Earth with stunning valleys and Dal Lake." },
  { id: 20, title: "Leh-Ladakh",           category: "India",         image: "https://unsplash.com/photos/a-view-of-a-city-with-mountains-in-the-background-ccAEmr9ZiLM/download?force=true",                        tags: ["Adventure","Mountains","Road Trip"],    description: "Stark mountain landscapes, monasteries, and high passes." },
  { id: 21, title: "Himachal Pradesh",     category: "India",         image: "https://unsplash.com/photos/a-black-and-white-photo-of-a-snow-covered-mountain-TZ8XxTBSJR4/download?force=true",                        tags: ["Mountains","Nature","Adventure"],       description: "Scenic hill stations, pine forests, and snow-capped peaks." },
  { id: 22, title: "Uttarakhand",          category: "India",         image: "https://unsplash.com/photos/a-landscape-with-trees-and-mountains-in-the-background-zw2fcskhzNI/download?force=true",                        tags: ["Mountains","Spiritual","Nature"],       description: "Land of Gods, featuring pilgrimage sites and Himalayan vistas." },
  { id: 23, title: "Rajasthan",            category: "India",         image: "https://unsplash.com/photos/a-large-yellow-building-sitting-on-top-of-a-lake-7FxtQi-FC5U/download?force=true",                        tags: ["History","Culture","Desert"],           description: "Royal palaces, vibrant culture, and vast desert landscapes." },
  ...
  { id: 26, title: "Andaman Islands",      category: "India",         image: "https://unsplash.com/photos/a-beach-with-palm-trees-on-the-shore-w2HQJ7BC-Bo/download?force=true",                        tags: ["Beaches","Islands","Adventure"],        description: "Pristine beaches, clear waters, and water sports." },
  { id: 27, title: "North East India",     category: "India",         image: "https://unsplash.com/photos/green-mountains-under-cloudy-sky-R5OHs2Bpn1c/download?force=true",                        tags: ["Nature","Culture","Offbeat"],           description: "Unexplored beauty, tribal culture, and biodiversity." },
  { id: 28, title: "Sikkim",               category: "India",         image: "https://unsplash.com/photos/a-town-with-many-buildings-WUI1aUmUzvQ/download?force=true",                        tags: ["Mountains","Nature","Monasteries"],     description: "Home to Kanchenjunga, scenic landscapes, and monasteries." },
  { id: 29, title: "Meghalaya",            category: "India",         image: "https://unsplash.com/photos/a-lush-green-field-with-mountains-in-the-background-dwK5C7h8MF4/download?force=true",                        tags: ["Nature","Waterfalls","Offbeat"],        description: "Abode of Clouds, known for living root bridges and waterfalls." },
  { id: 30, title: "Arunachal Pradesh",    category: "India",         image: "https://unsplash.com/photos/group-of-people-sitting-on-ground-during-daytime-IpRIguCAQes/download?force=true",                        tags: ["Mountains","Culture","Adventure"],      description: "Land of the Dawn-Lit Mountains with rich tribal heritage." },
  { id: 31, title: "Karnataka",            category: "India",         image: "https://unsplash.com/photos/a-waterfall-in-a-forest-VpRXOWwAXNc/download?force=true",                        tags: ["History","Nature","Culture"],           description: "Heritage sites like Hampi, coffee plantations in Coorg." },
  { id: 32, title: "Tamil Nadu",           category: "India",         image: "https://unsplash.com/photos/ancient-temples-are-shown-with-many-visitors-nearby-yx2u0ob2H3k/download?force=true",                        tags: ["Culture","Temples","Beaches"],          description: "Land of temples, rich culture, and coastal beauty." },
  { id: 33, title: "Pondicherry",          category: "India",         image: "https://unsplash.com/photos/a-blue-door-with-pink-flowers-growing-over-it-4xuEuD1WWDQ/download?force=true",                        tags: ["Beaches","French Colony","Relaxation"], description: "A touch of French culture on the Indian coast." },
  { id: 34, title: "West Bengal",          category: "India",         image: "https://unsplash.com/photos/a-view-of-a-city-from-a-high-point-of-view--nu54bLjh9A/download?force=true",                        tags: ["Culture","History","Mountains"],        description: "Cultural richness of Kolkata to the tea gardens of Darjeeling." },
  { id: 35, title: "Odisha",               category: "India",         image: "https://unsplash.com/photos/a-view-of-a-mountain-range-from-a-distance-NRrupu60Y04/download?force=true",                        tags: ["Culture","Temples","Beaches"],          description: "Known for its ancient temples, beaches, and tribal culture." },
  { id: 36, title: "Gujarat",              category: "India",         image: "https://unsplash.com/photos/a-view-of-a-city-from-a-high-viewpoint-KRtXOg-c9LE/download?force=true",                        tags: ["Culture","Wildlife","White Desert"],    description: "Rann of Kutch, Asiatic Lions, and vibrant traditions." },
  { id: 37, title: "Andhra Pradesh",       category: "India",         image: "https://unsplash.com/photos/a-view-of-a-mountain-range-from-a-distance-E5-p0widNr0/download?force=true",                        tags: ["Nature","Rivers","Culture"],            description: "Scenic Godavari rivers, paddy fields, and lush greenery." },
];
