...
const PAGE_CONFIG = {
  ...
  seasonLabel: "Best: Mar - May / Oct - Nov",

  heroSlides: [
    {
      label: "Mt. Fuji",
      alt: "Mount Fuji and Chureito Pagoda",
      src: "https://images.unsplash.com/photo-1490806843957-31f4c9a91c65?q=80&w=1920&auto=format&fit=crop",
    },
    {
      label: "Tokyo",
      alt: "Shibuya Crossing",
      src: "https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?q=80&w=1920&auto=format&fit=crop",
    },
    {
      label: "Kyoto",
    ...
    },
    {
      label: "Osaka",
      alt: "Dotonbori Canal",
      src: "https://images.unsplash.com/photo-1590253230536-cb65cc7f45b5?q=80&w=1920&auto=format&fit=crop",
    },
  ],
  ...
  itinerary: [
    {
      ...
      desc: "Konnichiwa! Welcome to Japan. Upon arrival at Narita or Haneda Airport, transfer to your hotel via private limousine bus or car. Tokyo is a dazzling metropolis of neon lights and ancient temples. Spend your first evening exploring the Shinjuku district, famous for its towering skyscrapers and Godzilla head.",
    },
    {
      day: "02",
      title: "Tokyo Highlights",
      desc: "Today we explore the capital. Visit the ancient Asakusa Senso-ji Temple and walk through the Nakamise shopping street. Then, experience the future at the teamLab Borderless digital art museum. In the evening, witness the famous Shibuya Crossing, the busiest pedestrian crossing in the world, and visit the Hachiko statue.",
    },
    {
      day: "03",
      title: "Mt. Fuji & Hakone Day Trip",
      desc: "We leave the city for nature. Drive to Mt. Fuji’s 5th Station (weather permitting) for breathtaking views of the iconic volcano. Later, enjoy a cruise on Lake Ashi in Hakone and a ropeway ride over the volcanic valley of Owakudani. Try the famous 'black eggs' cooked in sulfur springs, said to add 7 years to your life! Return to Tokyo.",
    },
    {
      day: "04",
      title: "Bullet Train to Kyoto",
      desc: "Experience the Shinkansen (Bullet Train) as we speed towards Kyoto at 300 km/h. Kyoto is the cultural heart of Japan. Upon arrival, visit the shimmering Golden Pavilion (Kinkaku-ji). In the afternoon, walk through the thousands of vermilion torii gates at Fushimi Inari Shrine. It is a spiritual and photogenic experience.",
    },
    {
      day: "05",
      title: "Nara Deer Park & Osaka",
      desc: "Short trip to Nara, Japan's first permanent capital. Here, over 1,000 wild deer roam freely in Nara Park—you can feed them special deer crackers. See the giant Buddha at Todai-ji Temple. We then continue to Osaka. In the evening, explore the vibrant Dotonbori district, famous for its neon Glico Man sign and incredible street food like Takoyaki.",
    },
    {
      day: "06",
      title: "Osaka Castle or Universal Studios",
      desc: "Today is flexible. You can choose a cultural tour to see the magnificent Osaka Castle and the Umeda Sky Building. Alternatively, spend the day at Universal Studios Japan (tickets optional) to visit the Wizarding World of Harry Potter and Super Nintendo World. Enjoy your final Japanese dinner in the lively Namba district.",
    },
    {
      day: "07",
      title: "Departure",
      desc: "Sayonara! After breakfast, transfer to Kansai International Airport (KIX) for your flight home. You leave with memories of sushi, shrines, and the warm hospitality of the Japanese people.",
    },
  ],
};

// ... (Rest of the component code is identical to other files, just copy-paste the structure below) ...
...
export default function JapanPage() {
  ...
  useEffect(() => {
    ...
    const interval = window.setInterval(() => { setActiveSlide((prev) => (prev + 1) % slides.length); }, 5000);
  ...
  return (
    <div className="min-h-screen bg-white antialiased selection:bg-[#2D3191]/10 selection:text-[#2D3191] pb-24 sm:pb-0">
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto w-full grid lg:grid-cols-2 gap-10 items-end">
          <div>
            ...
            <div className="flex items-center gap-2 mt-8">
              {slides.map((_, i) => (<button key={i} type="button" onClick={() => setActiveSlide(i)} className={`h-2.5 rounded-full transition-all duration-300 bg-white/40 hover:bg-white/70 ${i === activeSlide ? "w-10 bg-white" : "w-2.5"}`} />))}
            </div>
          </div>
          <div className="lg:text-right">
            <p className="text-white/80 text-lg mb-6">"Discover the land of the rising sun."</p>
      ...
      <section id="overview" className="py-20 px-6 sm:px-12 max-w-[1000px] mx-auto text-center">
        <h2 className="text-3xl font-semibold text-[#1F2328] mb-6" style={{ fontFamily: "'Playfair Display', serif" }}>The Golden Route</h2>
        <p className="text-lg text-[#1F2328]/70 leading-relaxed">Experience the perfect blend of old and new. From the high-tech streets of Tokyo to the tranquil temples of Kyoto and the street food culture of Osaka, this journey captures the essence of Japan. Ride the bullet train, see Mt. Fuji, and immerse yourself in a culture unlike any other.</p>
      </section>
      ...
      <section id="enquire" className="py-20 px-6 sm:px-12 max-w-[800px] mx-auto scroll-mt-24">
        <div className="bg-white p-8 sm:p-12 rounded-[2.5rem] border border-[#E6E8EF] shadow-xl text-center">
          <h2 className="text-3xl font-bold text-[#1F2328] mb-4">Dreaming of Japan?</h2>
