    ...
    <div className="min-h-screen bg-white antialiased">
      ...
      <section className="py-20 px-6 sm:px-12 max-w-[1000px] mx-auto text-center">
        ...
        <p className="text-lg text-[#1F2328]/70 leading-relaxed">
          Treat the whole family to an unforgettable holiday of a lifetime. From intimate island resorts to fun-filled adventure parks, we ensure your trip caters to everyone: grandparents, parents, and kids alike.
        </p>
      </section>
